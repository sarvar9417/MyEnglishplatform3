/**
 * EnglishPath — Seed data generator
 * Run: node scripts/generate-seed.mjs > supabase_seed.sql
 *
 * Converts hardcoded TS data into SQL INSERT statements (JSONB).
 * Data is inlined as plain JS objects (mirrors the TS source files).
 */
...
const grammarTopics = [
  {
    ...
    exercises: [
      { id: 1, type: 'fill-blank', instruction: "Bo'sh joylarni to'g'ri fe'l shaklida to'ldiring:", question: "If I _____ (have) more free time, I _____ (learn) to play the guitar.", blanks: ['had', 'would learn'], explanation: "'If' qismida Past Simple (had), natija qismida 'would + V¹' (would learn) ishlatiladi." },
      { id: 2, type: 'fill-blank', instruction: "Bo'sh joylarni to'g'ri fe'l shaklida to'ldiring:", question: "She _____ (travel) more often if she _____ (not have) so much work.", blanks: ['would travel', "didn't have"], explanation: "Natija qismi birinchi kelsa ham qoida o'zgarmaydi: 'would + V¹' va 'Past Simple negative'." },
      { id: 3, type: 'fill-blank', instruction: "Bo'sh joylarni to'g'ri fe'l shaklida to'ldiring:", question: "If it _____ (not rain) today, we _____ (go) for a picnic in the park.", blanks: ["didn't rain", 'would go'], explanation: "Inkor shakli: 'if it didn't rain' (Past Simple negative) + 'would go'." },
      { id: 4, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "If I ___ a million dollars, I would travel around the world.", options: ['had', 'have', 'will have', 'would have'], correct: 'had', explanation: "'If' qismida Past Simple ishlatiladi — 'had'. 'Would have' XATO: 'would' 'if' qismida ishlatilmaydi." },
      { id: 5, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "What would you do if you ___ a wallet on the street?", options: ['find', 'found', 'will find', 'would find'], correct: 'found', explanation: "'If' qismida Past Simple: 'found'. 'Would find' xato — 'would' natija qismiga tegishli." },
      { id: 6, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "If she worked harder, she ___ get a promotion.", options: ['would', 'will', 'should', 'had'], correct: 'would', explanation: "Natija qismida 'would + V¹' ishlatiladi. 'Will' Present/Future real shartlar uchun (First Conditional)." },
      { id: 7, type: 'error-correction', instruction: "Grammatik xatoni toping va gapni to'g'irlang:", question: "If I would have more money, I would buy a bigger house.", errorPart: 'would have', correct: "If I had more money, I would buy a bigger house.", explanation: "'If' qismida 'would' ISHLATILMAYDI. To'g'ri shakl: 'If I had...' (Past Simple)." },
      { id: 8, type: 'error-correction', instruction: "Grammatik xatoni toping va gapni to'g'irlang:", question: "If he studied more, he will pass the exam easily.", errorPart: 'will pass', correct: "If he studied more, he would pass the exam easily.", explanation: "Second Conditional natija qismida 'will' emas 'would' ishlatiladi: 'would pass'." },
      { id: 9, type: 'transformation', instruction: "Quyidagi gapni Second Conditional shaklida yozing:", question: "I don't have a car, so I can't drive to work.", hint: "If I had a car, ...", correct: "If I had a car, I would drive to work.", explanation: "Real holat ('don't have' → 'had') xayoliyga o'tadi, natija: 'would drive' (would + V¹)." },
      { id: 10, type: 'transformation', instruction: "Quyidagi gapni Second Conditional shaklida yozing:", question: "She doesn't know the answer, so she can't help you.", hint: "If she knew ...", correct: "If she knew the answer, she would help you.", explanation: "'doesn't know' → 'knew' (Past Simple); 'can't help' → 'would help' (would + V¹)." },
    ],
  },
  {
    id: 'present-perfect',
    ...
    exercises: [
      { id: 1, type: 'fill-blank', instruction: "Present Perfect bilan bo'sh joylarni to'ldiring:", question: 'I _____ (live) in Tashkent for five years.', blanks: ['have lived'], explanation: "'For five years' = davom etayotgan vaqt → Present Perfect (have + lived)." },
      { id: 2, type: 'fill-blank', instruction: "Present Perfect bilan bo'sh joylarni to'ldiring:", question: 'She _____ (already / finish) the project. It looks great!', blanks: ['has already finished'], explanation: "'Already' Present Perfect bilan ishlatiladi: has + already + V³." },
      { id: 3, type: 'fill-blank', instruction: "Present Perfect bilan bo'sh joylarni to'ldiring:", question: 'They _____ (visit) Paris three times in their lives.', blanks: ['have visited'], explanation: "'Three times' = necha marta (tajriba) → Present Perfect." },
      { id: 4, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "I ___ this film before — it's absolutely brilliant!", options: ['have seen', 'saw', 'see', 'was seeing'], correct: 'have seen', explanation: "'Before' = aniq vaqtsiz tajriba → Present Perfect: 'have seen'." },
      { id: 5, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'She ___ to the market this morning. (It is now 3pm.)', options: ['went', 'has gone', 'has went', 'goes'], correct: 'went', explanation: "'This morning' = tugallangan vaqt (hozir tushdan keyin) → Past Simple: 'went'." },
      { id: 6, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'How long ___ you known each other?', options: ['have', 'did', 'do', 'had'], correct: 'have', explanation: "'How long' + davom etayotgan holat → Present Perfect: 'How long have you known...?'" },
      { id: 7, type: 'error-correction', instruction: "Grammatik xatoni toping va to'g'irlang:", question: 'I have saw this movie last night with my friends.', errorPart: 'have saw', correct: 'I saw this movie last night with my friends.', explanation: "'Last night' = aniq tugallangan vaqt → Past Simple kerak, Present Perfect emas." },
      { id: 8, type: 'error-correction', instruction: "Grammatik xatoni toping va to'g'irlang:", question: 'He has finished his work two hours ago.', errorPart: 'has finished', correct: 'He finished his work two hours ago.', explanation: "'Two hours ago' = aniq o'tmish → Past Simple. Present Perfect bilan 'ago' ishlatilmaydi." },
      { id: 9, type: 'transformation', instruction: 'Present Perfect bilan yozing:', question: 'The last time I ate pizza was a month ago.', hint: "I haven't eaten ...", correct: "I haven't eaten pizza for a month.", explanation: "O'tmishdan hozirga qadar yuz bermagan holat → Present Perfect negative + 'for'." },
      { id: 10, type: 'transformation', instruction: 'Present Perfect bilan yozing:', question: 'This is my first visit to London.', hint: 'I have never ...', correct: 'I have never been to London before.', explanation: "Birinchi marta → 'have never + been to + place + before'." },
    ],
  },
  {
    id: 'passive-voice',
    ...
    exercises: [
      { id: 1, type: 'fill-blank', instruction: 'Passive Voice (Present Simple) bilan to\'ldiring:', question: 'English _____ (speak) as an official language in over 50 countries.', blanks: ['is spoken'], explanation: "Present Simple Passive: is/am/are + V³. Subject 'English' → yakkama, demak 'is spoken'." },
      { id: 2, type: 'fill-blank', instruction: 'Passive Voice (Past Simple) bilan to\'ldiring:', question: 'The first iPhone _____ (introduce) by Steve Jobs in 2007.', blanks: ['was introduced'], explanation: "Past Simple Passive: was/were + V³. 'The first iPhone' → yakka → 'was introduced'." },
      { id: 3, type: 'fill-blank', instruction: 'Passive Voice (Present Perfect) bilan to\'ldiring:', question: 'The new policy _____ (approve) by the board this week.', blanks: ['has been approved'], explanation: "Present Perfect Passive: have/has + been + V³. Yakka subject → 'has been approved'." },
      { id: 4, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'The movie ___ directed by Christopher Nolan.', options: ['was', 'is', 'were', 'has'], correct: 'was', explanation: "Past Simple Passive: 'was + directed'. 'Were' ko'plik uchun; 'is' Present uchun." },
      { id: 5, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Thousands of cars ___ produced in this factory every month.', options: ['are', 'is', 'were', 'be'], correct: 'are', explanation: "'Thousands of cars' = ko'plik → Present Simple Passive: 'are + produced'." },
      { id: 6, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'The exam results ___ announced tomorrow morning.', options: ['will be', 'are', 'were', 'have been'], correct: 'will be', explanation: "'Tomorrow' = kelajak → Future Simple Passive: 'will be + announced'." },
      { id: 7, type: 'error-correction', instruction: "Grammatik xatoni toping va to'g'irlang:", question: 'The dinner was cook by my mother last night.', errorPart: 'cook', correct: 'The dinner was cooked by my mother last night.', explanation: "Passive Voice da Past Participle (V³) kerak: 'cook' → 'cooked'." },
      { id: 8, type: 'error-correction', instruction: "Grammatik xatoni toping va to'g'irlang:", question: 'Many books has been wrote by this famous author.', errorPart: 'has been wrote', correct: 'Many books have been written by this famous author.', explanation: "'Many books' = ko'plik → 'have' (has emas). 'Wrote' → 'written' (V³ — wrote xato)." },
      { id: 9, type: 'transformation', instruction: 'Active gapni Passive shakliga o\'tkazing:', question: 'Shakespeare wrote Romeo and Juliet in the 1590s.', hint: 'Romeo and Juliet was ...', correct: 'Romeo and Juliet was written by Shakespeare in the 1590s.', explanation: "Active ob'ekt → Passive subject. 'wrote' → 'was written'. Ijrochi: 'by Shakespeare'." },
      { id: 10, type: 'transformation', instruction: 'Active gapni Passive shakliga o\'tkazing:', question: 'Scientists around the world are researching new treatments.', hint: 'New treatments are being ...', correct: 'New treatments are being researched by scientists around the world.', explanation: "Present Continuous Passive: 'are being + V³'. Active ob'ekt → Passive subject." },
    ],
  },
  {
    id: 'comparatives-superlatives',
    ...
    exercises: [
      { id: 1, type: 'fill-blank', instruction: "Bo'sh joyni comparative yoki superlative bilan to'ldiring:", question: 'A car is _____ (fast) than a bicycle.', blanks: ['faster'], explanation: "'Fast' qisqa sifat (1 bo'g'in) → comparative: 'faster'. 'Than' bilan solishtirish." },
      { id: 2, type: 'fill-blank', instruction: "Bo'sh joyni comparative yoki superlative bilan to'ldiring:", question: 'Mount Everest is _____ (high) mountain in the world.', blanks: ['the highest'], explanation: "'In the world' = eng yuqori → Superlative: 'the highest'." },
      { id: 3, type: 'fill-blank', instruction: "Bo'sh joyni comparative yoki superlative bilan to'ldiring:", question: 'This exercise is _____ (easy) than the last one.', blanks: ['easier'], explanation: "'Easy' → -y bilan tugagan → 'y' → 'i' + 'er': 'easier'. 'Than' = comparative." },
      { id: 4, type: 'fill-blank', instruction: "Bo'sh joyni comparative yoki superlative bilan to'ldiring:", question: 'She speaks English _____ (good) than me.', blanks: ['better'], explanation: "'Good' noto'g'ri shakl → 'better' (comparative). 'Gooder' deyilmaydi!" },
      { id: 5, type: 'multiple-choice', instruction: "To'g'ri comparative shaklni tanlang:", question: 'This book is ___ than that one.', options: ['more interesting', 'interesting', 'the most interesting', 'interestinger'], correct: 'more interesting', explanation: "'Interesting' uzun sifat (3 bo'g'in) → 'more + interesting'. 'Than' → comparative." },
      { id: 6, type: 'multiple-choice', instruction: "To'g'ri superlative shaklni tanlang:", question: 'She is ___ girl in our class.', options: ['the most tall', 'taller', 'the tallest', 'tallest'], correct: 'the tallest', explanation: "Superlative: 'the + tallest'. 'The' va '-est' qisqa sifatga qo'shiladi." },
      { id: 7, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Who is ___ person in your family?', options: ['the most old', 'the oldest', 'older', 'oldest'], correct: 'the oldest', explanation: "'In your family' = guruh → Superlative: 'the oldest'." },
      { id: 8, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'This is ___ book I have ever read. I love it!', options: ['the better', 'the goodest', 'the best', 'better'], correct: 'the best', explanation: "'Good' → superlative: 'the best'. 'Ever' = hozirgacha eng yaxshisi." },
      { id: 9, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Which sentence is CORRECT?', options: ['She is more taller than me.', 'She is taller than me.', 'She is more tall than me.', 'She is the most tallest.'], correct: 'She is taller than me.', explanation: "'Taller' o'zi comparative. 'More taller' (double) xato." },
      { id: 10, type: 'error-correction', instruction: "Grammatik xatoni toping va to'g'irlang:", question: 'She is more taller than her sister.', errorPart: 'more taller', correct: 'She is taller than her sister.', explanation: "'Tall' qisqa → faqat '-er': 'taller'. 'More' qo'shilmaydi — double comparative xato." },
      { id: 11, type: 'error-correction', instruction: "Grammatik xatoni toping va to'g'irlang:", question: 'My English is getting gooder every day!', errorPart: 'gooder', correct: 'My English is getting better every day!', explanation: "'Good' noto'g'ri sifat — comparative: 'better'. 'Gooder' deyilmaydi." },
      { id: 12, type: 'error-correction', instruction: "Grammatik xatoni toping va to'g'irlang:", question: 'February is the most coldest month of the year.', errorPart: 'most coldest', correct: 'February is the coldest month of the year.', explanation: "'Cold' qisqa → 'the coldest'. 'Most' bilan '-est' birga ishlatilmaydi." },
      { id: 13, type: 'error-correction', instruction: "Grammatik xatoni toping va to'g'irlang:", question: 'She is taller then her brother.', errorPart: 'then', correct: 'She is taller than her brother.', explanation: "'Then' = 'keyin', 'than' = 'dan/ga qaraganda'. Comparative bilan 'than' ishlatiladi." },
      { id: 14, type: 'error-correction', instruction: "Grammatik xatoni toping va to'g'irlang:", question: 'This is the most easy test I have ever taken.', errorPart: 'most easy', correct: 'This is the easiest test I have ever taken.', explanation: "'Easy' -y bilan tugaydi → 'y' → 'i' + 'est': 'the easiest'. 'The most easy' xato." },
      { id: 15, type: 'transformation', instruction: 'Gapni Comparative shaklida qayta yozing:', question: 'Russia is large. Canada is larger.', hint: 'Canada is ...', correct: 'Canada is larger than Russia.', explanation: "Solishtirish → 'larger than'. 'Large' → 'larger' (e bilan → faqat '-r')." },
      { id: 16, type: 'transformation', instruction: 'Superlative bilan gap tuzing:', question: 'No other student in the class is as tall as him.', hint: 'He is ...', correct: 'He is the tallest student in the class.', explanation: "Eng yuqori daraja → 'the + tallest'." },
      { id: 17, type: 'transformation', instruction: "Gapni 'as ... as' yordamida qayta yozing:", question: 'My car is faster than yours.', hint: 'Your car is not ...', correct: "Your car is not as fast as mine.", explanation: "'Faster than' → 'not as fast as'. 'As + adj + as' tengsizlikni bildiradi." },
      { id: 18, type: 'transformation', instruction: 'Superlative bilan qayta yozing:', question: 'I have never eaten a more delicious plov than this one.', hint: 'This is ...', correct: 'This is the most delicious plov I have ever eaten.', explanation: "'Never ... more' → 'the most'. 'Delicious' uzun → 'the most delicious'." },
      { id: 19, type: 'fill-blank', instruction: "Comparative yoki Superlative bilan to'ldiring:", question: "This is _____ (bad) meal I have ever eaten. I can't eat it!", blanks: ['the worst'], explanation: "'Bad' → noto'g'ri: 'the worst' (superlative). 'Ever' = hozirgacha eng yomoni." },
      { id: 20, type: 'fill-blank', instruction: "Comparative yoki Superlative bilan to'ldiring:", question: 'Summer is _____ (hot) than spring in Uzbekistan.', blanks: ['hotter'], explanation: "'Hot' → qisqa, CVC (undosh+unli+undosh) → undosh ikki marta: 'hotter'." },
    ],
  },
]
...
const readingTexts = [
  ...
  },
  {
    ...
    questions: [
      { id: 1, question: 'What problem with traditional classrooms does the text identify?', options: ['Classes are too large for effective teaching.', 'Teachers are not trained to use technology.', 'Students are not motivated to learn in classrooms.', 'All students are taught at the same pace, regardless of ability.'], correctIndex: 3, explanation: 'Paragraph 2 states that traditional classrooms "teach all students at the same pace, which can be frustrating."' },
      { id: 2, question: 'How do adaptive AI systems help students learn more effectively?', options: ['By providing more homework assignments each day.', 'By replacing classroom teachers with digital tutors.', 'By adjusting the level and pace of content to match each learner.', 'By connecting students with tutors around the world.'], correctIndex: 2, explanation: 'Paragraph 2 explains that adaptive AI technology "automatically adjusts the level and pace of content to match each learner."' },
      { id: 3, question: 'What concern do some educators have about AI in classrooms?', options: ['AI tools are too expensive for most schools to afford.', 'AI may prevent students from developing cognitive skills.', 'Students prefer to learn without the help of technology.', 'Teachers cannot learn to use AI tools effectively.'], correctIndex: 1, explanation: 'Paragraph 4 warns that AI may "limit opportunities for students to develop essential cognitive skills."' },
      { id: 4, question: 'How can data collected by AI systems benefit teachers?', options: ['It allows teachers to work fewer hours each week.', 'It helps teachers design better school buildings.', 'It allows teachers to identify students who need extra support.', 'It replaces the need for traditional assessment methods.'], correctIndex: 2, explanation: 'Paragraph 3 states that "data collected by these systems allows teachers to identify which students need extra support."' },
      { id: 5, question: "What is the writer's overall conclusion about AI in education?", options: ['AI will soon completely replace human teachers.', 'The risks of AI in education outweigh the benefits.', 'AI should only be used for marking and assessment.', 'When used responsibly, AI can improve education for all learners.'], correctIndex: 3, explanation: 'The final paragraph concludes that AI "has enormous potential to make education fairer, more efficient, and more engaging."' },
    ],
  },
]
...
const speakingPrompts = [
  { id: 'daily-routine', category: 'personal', prompt: 'Describe your typical daily routine. What time do you wake up? What do you usually do in the morning, afternoon, and evening?', tips: ['Use present simple tense', 'Include time expressions: first, then, after that, finally', 'Mention 4–5 activities'], timeSeconds: 60 },
  { id: 'hometown', category: 'personal', prompt: 'Describe your hometown or city. What do you like most about it? Is there anything you would change?', tips: ['Use descriptive adjectives (busy, quiet, modern, historic)', 'Mention location, size, and special features', 'Compare past and present if possible'], timeSeconds: 90 },
  { id: 'favourite-food', category: 'personal', prompt: 'Tell me about your favourite food or meal. How is it made? When do you usually eat it? Why do you enjoy it?', tips: ['Use sensory words: taste, smell, texture', 'Explain the key ingredients', 'Talk about occasions when you eat it'], timeSeconds: 60 },
  { id: 'weekend-plans', category: 'personal', prompt: 'What do you usually do at weekends? Do you prefer spending time at home or going out? Describe your perfect weekend.', tips: ['Use present simple for routines, future for plans', 'Compare different activities', 'Explain why you enjoy certain activities'], timeSeconds: 90 },
  { id: 'education-background', category: 'personal', prompt: 'Tell me about your education. What subjects did you enjoy most at school? Why did you choose your current field of study?', tips: ['Use past tenses for previous education', 'Use present tenses for current study', 'Explain your motivations'], timeSeconds: 90 },
  // ── Opinion ──
  { id: 'technology-opinion', category: 'opinion', prompt: "What is your opinion on social media? Do you think it has a more positive or negative impact on society? Give specific reasons.", tips: ['State your main opinion clearly', 'Give at least two supporting reasons', 'Mention a counter-argument'], timeSeconds: 120 },
  { id: 'environment', category: 'opinion', prompt: "What is the biggest environmental problem in your country? What should the government and individuals do to address it?", tips: ['Identify a specific problem', 'Suggest both government and individual actions', 'Use conditional structures'], timeSeconds: 120 },
  { id: 'city-vs-country', category: 'opinion', prompt: 'Do you prefer living in a big city or a small town? Explain the advantages and disadvantages of each option.', tips: ['Compare both sides', 'Give specific examples', 'State your personal preference with reasons'], timeSeconds: 90 },
  ...
  // ── Description ──
  { id: 'describe-person', category: 'description', prompt: 'Describe a person who has had a significant influence on your life. Who are they? What qualities do you admire in them?', tips: ['Use descriptive adjectives', 'Explain how they influenced you', 'Include specific memories or examples'], timeSeconds: 120 },
  { id: 'describe-place', category: 'description', prompt: 'Describe a place you have visited that left a strong impression on you. What made it special?', tips: ['Use sensory language: sight, sound, smell', 'Describe the atmosphere', 'Explain why it was memorable'], timeSeconds: 90 },
  { id: 'describe-object', category: 'description', prompt: 'Describe an important object in your life. What is it? What does it look like? Why is it meaningful to you?', tips: ['Describe physical appearance in detail', 'Explain the emotional value', 'Use present and past tenses'], timeSeconds: 60 },
  { id: 'dream-home', category: 'description', prompt: 'Describe your dream home. Where would it be? What would it look like? What special features would it have?', tips: ['Use conditional structures (would, could)', 'Describe rooms and features in detail', 'Explain why you would choose those features'], timeSeconds: 90 },
  // ── Narrative ──
  { id: 'memorable-journey', category: 'narrative', prompt: 'Tell me about a memorable journey you have taken. Where did you go? What happened? Why was it memorable?', tips: ['Use past tenses consistently', 'Describe events in order', 'Include feelings and reactions'], timeSeconds: 120 },
  { id: 'achievement', category: 'narrative', prompt: 'Describe an achievement you are proud of. What did you do? What challenges did you face? How did you feel when you succeeded?', tips: ['Use past tenses for the story', 'Describe the challenge and how you overcame it', 'Explain why it was important to you'], timeSeconds: 120 },
  { id: 'childhood-memory', category: 'narrative', prompt: 'Describe a happy memory from your childhood. What happened? Who was with you? Why does this memory stay with you?', tips: ['Use past tenses (Past Simple, Past Continuous)', 'Describe sensory details (sights, sounds, smells)', 'Explain the emotional significance'], timeSeconds: 90 },
  { id: 'cultural-event', category: 'narrative', prompt: 'Describe a traditional festival or celebration in your country. What happens during this event? How do people prepare? What do you enjoy most about it?', tips: ['Describe the sequence of events', 'Explain cultural significance', 'Use present tenses for general traditions'], timeSeconds: 90 },
  // ── Abstract ──
  { id: 'happiness-definition', category: 'abstract', prompt: 'What does happiness mean to you? Is it the same for everyone? Can money buy happiness?', tips: ['Define your understanding of the concept', 'Give personal examples', 'Discuss different perspectives'], timeSeconds: 120 },
  { id: 'success-definition', category: 'abstract', prompt: 'How do you define success? Is it measured by wealth, career, relationships, or something else?', tips: ['Offer a personal definition of success', 'Discuss cultural differences in defining success', 'Support your opinion with examples'], timeSeconds: 90 },
  { id: 'learning-importance', category: 'abstract', prompt: 'Why is learning English important in today\'s world? How will it help you in your future career and personal life?', tips: ['Discuss global importance', 'Connect to your personal goals', 'Use future tenses'], timeSeconds: 90 },
]
...
const writingPrompts = [
  { id: 'wp-1', type: 'opinion', prompt: 'Some people believe that social media has a negative impact on society. Do you agree or disagree? Give reasons for your answer and include any relevant examples from your own experience.', wordLimit: 250, timeMinutes: 40, tips: ['Clearly state your opinion in the introduction', 'Give 2-3 well-developed arguments with examples', 'Address a counter-argument before concluding'] },
  { id: 'wp-2', type: 'opinion', prompt: 'In your opinion, what is the most important quality for a good leader? Support your answer with specific reasons and examples from your own knowledge or experience.', wordLimit: 200, timeMinutes: 35, tips: ['Define what leadership means to you', 'Choose 1-2 qualities and explain why', 'Provide real-life examples of good leaders'] },
...
const b1Questions = [
  // Grammar (15)
  { level: 'B1', section: 'grammar', q: 'She ___ to school every day.', opts: ['go', 'goes', 'going', 'went'], ans: 1 },
  { level: 'B1', section: 'grammar', q: 'They ___ playing football when it started raining.', opts: ['are', 'were', 'have been', 'will be'], ans: 1 },
  { level: 'B1', section: 'grammar', q: "I have ___ finished my homework.", opts: ['yet', 'already', 'since', 'for'], ans: 1 },
  { level: 'B1', section: 'grammar', q: 'If I ___ rich, I would travel the world.', opts: ['am', 'was', 'were', 'will be'], ans: 2 },
  { level: 'B1', section: 'grammar', q: 'The book ___ written by J.K. Rowling.', opts: ['is', 'was', 'were', 'has'], ans: 1 },
  { level: 'B1', section: 'grammar', q: 'We have lived in this city ___ 2015.', opts: ['for', 'since', 'ago', 'during'], ans: 1 },
  { level: 'B1', section: 'grammar', q: 'She is ___ than her sister.', opts: ['tall', 'taller', 'tallest', 'more tall'], ans: 1 },
  { level: 'B1', section: 'grammar', q: 'You ___ eat healthy food.', opts: ['must', 'should', 'have to', 'all are correct'], ans: 3 },
  { level: 'B1', section: 'grammar', q: "He doesn't like coffee, ___?", opts: ['does he', 'doesn\'t he', 'likes he', 'is he'], ans: 0 },
  { level: 'B1', section: 'grammar', q: 'I ___ to the cinema last night.', opts: ['go', 'went', 'have gone', 'was going'], ans: 1 },
  { level: 'B1', section: 'grammar', q: 'This is the ___ film I have ever seen.', opts: ['good', 'better', 'best', 'more good'], ans: 2 },
  { level: 'B1', section: 'grammar', q: 'While I ___ TV, the phone rang.', opts: ['watched', 'was watching', 'have watched', 'watch'], ans: 1 },
  { level: 'B1', section: 'grammar', q: 'She asked me where I ___.', opts: ['live', 'lived', 'am living', 'will live'], ans: 1 },
  { level: 'B1', section: 'grammar', q: 'The room ___ cleaned every day.', opts: ['is', 'was', 'has', 'will'], ans: 0 },
  { level: 'B1', section: 'grammar', q: 'We ___ each other for 10 years.', opts: ['know', 'knew', 'have known', 'are knowing'], ans: 2 },
  // Vocabulary (10)
  { level: 'B1', section: 'vocabulary', q: 'What does "beneficial" mean?', opts: ['useful and helpful', 'harmful', 'beautiful', 'expensive'], ans: 0 },
  { level: 'B1', section: 'vocabulary', q: 'Select the synonym of "important":', opts: ['minor', 'significant', 'small', 'ordinary'], ans: 1 },
  { level: 'B1', section: 'vocabulary', q: 'What is the opposite of "increase"?', opts: ['grow', 'rise', 'decrease', 'expand'], ans: 2 },
  { level: 'B1', section: 'vocabulary', q: '"Environment" refers to:', opts: ['the economy', 'the natural world', 'technology', 'transport'], ans: 1 },
  { level: 'B1', section: 'vocabulary', q: 'Select the correct meaning of "opportunity":', opts: ['a problem', 'a chance for improvement', 'a job', 'a decision'], ans: 1 },
  { level: 'B1', section: 'vocabulary', q: 'Which word means "to make something better"?', opts: ['damage', 'improve', 'prevent', 'reduce'], ans: 1 },
  { level: 'B1', section: 'vocabulary', q: '"Essential" is closest in meaning to:', opts: ['optional', 'necessary', 'unimportant', 'rare'], ans: 1 },
  { level: 'B1', section: 'vocabulary', q: 'What does "poverty" mean?', opts: ['wealth', 'being very poor', 'health', 'education'], ans: 1 },
  { level: 'B1', section: 'vocabulary', q: 'The word "flexible" means:', opts: ['able to change easily', 'very strong', 'unable to move', 'very fast'], ans: 0 },
  { level: 'B1', section: 'vocabulary', q: '"Consequence" is:', opts: ['a cause', 'a result of an action', 'a decision', 'a plan'], ans: 1 },
  // Reading (5)
  { level: 'B1', section: 'reading', passage: 'The Amazon rainforest is the largest tropical rainforest in the world. It covers about 5.5 million square kilometres and is home to millions of plant and animal species. The rainforest plays a vital role in regulating the Earth\'s climate by absorbing carbon dioxide. However, deforestation is destroying large areas of the forest every year, threatening biodiversity and contributing to climate change.', q: 'What is the main role of the Amazon rainforest mentioned in the text?', opts: ['It is the largest forest in the world.', 'It produces food for local communities.', 'It regulates the Earth\'s climate.', 'It provides wood for construction.'], ans: 2 },
  { level: 'B1', section: 'reading', passage: 'The Amazon rainforest is the largest tropical rainforest in the world. It covers about 5.5 million square kilometres and is home to millions of plant and animal species. The rainforest plays a vital role in regulating the Earth\'s climate by absorbing carbon dioxide. However, deforestation is destroying large areas of the forest every year, threatening biodiversity and contributing to climate change.', q: 'What problem does the text identify?', opts: ['The forest is too large.', 'Deforestation is destroying the forest.', 'Too many animals live there.', 'The climate is too hot.'], ans: 1 },
  { level: 'B1', section: 'reading', passage: 'Water is essential for all forms of life on Earth. Despite this, millions of people around the world lack access to clean drinking water. Water scarcity affects every continent and is caused by factors such as pollution, climate change, and inefficient water use. Addressing this crisis requires urgent action at both local and global levels.', q: 'What causes water scarcity according to the text?', opts: ['Too much rainfall', 'Pollution, climate change, and inefficient use', 'Overpopulation in cities', 'Lack of technology'], ans: 1 },
  { level: 'B1', section: 'reading', passage: 'Water is essential for all forms of life on Earth. Despite this, millions of people around the world lack access to clean drinking water. Water scarcity affects every continent and is caused by factors such as pollution, climate change, and inefficient water use. Addressing this crisis requires urgent action at both local and global levels.', q: 'What does the text suggest about solving the water crisis?', opts: ['Only governments can solve it.', 'It requires action at local and global levels.', 'It is impossible to solve.', 'Technology alone will fix it.'], ans: 1 },
  { level: 'B1', section: 'reading', passage: 'English has become the global language of business, science, and technology. Over one billion people speak English worldwide, though only about 375 million are native speakers. The rest have learned it as a second or foreign language. English continues to evolve, absorbing words from other languages and adapting to new contexts.', q: 'How many people speak English as a second or foreign language according to the text?', opts: ['About 375 million', 'Over one billion', 'About 625 million', 'Exactly one billion'], ans: 2 },
]

const b2Questions = [
  // Grammar (15)
  { level: 'B2', section: 'grammar', q: 'By the time we arrived, the concert ___.', opts: ['starts', 'started', 'had started', 'has started'], ans: 2 },
  { level: 'B2', section: 'grammar', q: 'I wish I ___ more time to prepare for the exam.', opts: ['had', 'have', 'would have', 'will have'], ans: 0 },
  { level: 'B2', section: 'grammar', q: 'She is ___ experienced candidate we have interviewed.', opts: ['more', 'most', 'the most', 'a more'], ans: 2 },
  { level: 'B2', section: 'grammar', q: 'The report ___ by the end of the week.', opts: ['will complete', 'will be completed', 'will have complete', 'completes'], ans: 1 },
  { level: 'B2', section: 'grammar', q: 'Had I known about the meeting, I ___ attended.', opts: ['will have', 'would have', 'had', 'have'], ans: 1 },
  { level: 'B2', section: 'grammar', q: 'She suggested that we ___ earlier.', opts: ['leave', 'left', 'would leave', 'had left'], ans: 0 },
  { level: 'B2', section: 'grammar', q: 'The company ___ in 1995 by two entrepreneurs.', opts: ['founded', 'was founded', 'has founded', 'founding'], ans: 1 },
  { level: 'B2', section: 'grammar', q: 'Not only ___ the exam, but she also got the highest score.', opts: ['she passed', 'did she pass', 'she did pass', 'passed she'], ans: 1 },
  { level: 'B2', section: 'grammar', q: 'He spoke English ___ than I expected.', opts: ['more fluent', 'more fluently', 'fluently', 'most fluent'], ans: 1 },
  { level: 'B2', section: 'grammar', q: 'The documents ___ prepared before the meeting starts.', opts: ['must be', 'must have', 'are must', 'must to'], ans: 0 },
  { level: 'B2', section: 'grammar', q: 'It is essential that every student ___ the rules.', opts: ['follow', 'follows', 'following', 'followed'], ans: 0 },
  { level: 'B2', section: 'grammar', q: 'Were she to win the competition, she ___ delighted.', opts: ['will be', 'would be', 'is', 'was'], ans: 1 },
  { level: 'B2', section: 'grammar', q: 'The longer you wait, ___ it becomes.', opts: ['hard', 'the harder', 'harder', 'more hard'], ans: 1 },
  { level: 'B2', section: 'grammar', q: 'He denied ___ the window.', opts: ['to break', 'breaking', 'break', 'broke'], ans: 1 },
  { level: 'B2', section: 'grammar', q: '___ the heavy traffic, we arrived on time.', opts: ['Despite', 'Although', 'Because of', 'In spite'], ans: 0 },
  // Vocabulary (10)
  { level: 'B2', section: 'vocabulary', q: '"Innovative" most closely means:', opts: ['traditional', 'creative and original', 'expensive', 'simple'], ans: 1 },
  { level: 'B2', section: 'vocabulary', q: 'What does "implement" mean?', opts: ['to remove', 'to put into effect', 'to create', 'to design'], ans: 1 },
  { level: 'B2', section: 'vocabulary', q: '"Consequently" is used to:', opts: ['contrast ideas', 'show result', 'add information', 'give examples'], ans: 1 },
  { level: 'B2', section: 'vocabulary', q: 'Which word means "to make something less severe"?', opts: ['intensify', 'alleviate', 'deteriorate', 'aggravate'], ans: 1 },
  { level: 'B2', section: 'vocabulary', q: '"Inevitable" means:', opts: ['unlikely to happen', 'certain to happen', 'possible to avoid', 'rarely occurring'], ans: 1 },
  { level: 'B2', section: 'vocabulary', q: 'The opposite of "temporary" is:', opts: ['brief', 'permanent', 'short-term', 'transient'], ans: 1 },
  { level: 'B2', section: 'vocabulary', q: '"To evaluate" means:', opts: ['to create', 'to assess', 'to ignore', 'to produce'], ans: 1 },
  { level: 'B2', section: 'vocabulary', q: '"Paradox" is:', opts: ['a common belief', 'a contradictory statement', 'a scientific theory', 'a historical event'], ans: 1 },
  { level: 'B2', section: 'vocabulary', q: 'Select the meaning of "controversial":', opts: ['widely accepted', 'causing disagreement', 'very simple', 'highly enjoyable'], ans: 1 },
  { level: 'B2', section: 'vocabulary', q: '"Substantial" means:', opts: ['insignificant', 'considerable in size', 'hollow', 'temporary'], ans: 1 },
  // Reading (5)
  { level: 'B2', section: 'reading', passage: 'The concept of the sharing economy has transformed how people access goods and services. Platforms like Airbnb and Uber have demonstrated that peer-to-peer exchange can be more efficient and affordable than traditional business models. However, critics argue that this shift often circumvents labour protections (such as minimum wage and sick leave), raises concerns about safety standards, and disrupts established industries. The challenge for policymakers is to regulate these new models without stifling innovation.', q: 'What is a key benefit of the sharing economy mentioned in the text?', opts: ['It guarantees higher wages.', 'It is more efficient and affordable.', 'It eliminates all regulations.', 'It ensures safety for all users.'], ans: 1 },
  { level: 'B2', section: 'reading', passage: 'The concept of the sharing economy has transformed how people access goods and services. Platforms like Airbnb and Uber have demonstrated that peer-to-peer exchange can be more efficient and affordable than traditional business models. However, critics argue that this shift often circumvents labour protections (such as minimum wage and sick leave), raises concerns about safety standards, and disrupts established industries. The challenge for policymakers is to regulate these new models without stifling innovation.', q: 'What concern do critics raise about the sharing economy?', opts: ['It makes goods too expensive.', 'It avoids labour protections and raises safety concerns.', 'It is not profitable for businesses.', 'It only works in large cities.'], ans: 1 },
  { level: 'B2', section: 'reading', passage: 'Climate change is one of the most pressing challenges of our time. Scientific evidence overwhelmingly indicates that human activities, particularly the burning of fossil fuels, are driving changes in the Earth\'s climate system. The consequences include rising sea levels, more frequent extreme weather events, and loss of biodiversity. While international agreements like the Paris Accord aim to coordinated action, implementation remains uneven across nations. Addressing climate change requires a fundamental transformation of our energy systems, agricultural practices, and consumption patterns.', q: 'What does the text identify as the main driver of climate change?', opts: ['Natural weather cycles', 'Burning fossil fuels', 'Volcanic activity', 'Solar radiation'], ans: 1 },
  { level: 'B2', section: 'reading', passage: 'Climate change is one of the most pressing challenges of our time. Scientific evidence overwhelmingly indicates that human activities, particularly the burning of fossil fuels, are driving changes in the Earth\'s climate system. The consequences include rising sea levels, more frequent extreme weather events, and loss of biodiversity. While international agreements like the Paris Accord aim to coordinated action, implementation remains uneven across nations. Addressing climate change requires a fundamental transformation of our energy systems, agricultural practices, and consumption patterns.', q: 'What does the text say about international agreements on climate change?', opts: ['They have solved the problem completely.', 'Implementation varies across countries.', 'All nations have implemented them equally.', 'They focus only on energy systems.'], ans: 1 },
  { level: 'B2', section: 'reading', passage: 'The gig economy, characterised by short-term contracts and freelance work, has grown significantly over the past decade. While it offers flexibility for workers and lower costs for employers, it also raises questions about job security, benefits, and workers\' rights. Many gig workers do not receive health insurance, paid leave, or pension contributions. Some governments are now introducing legislation to extend these protections to gig workers, but the debate continues about how to balance flexibility with security.', q: 'What is a disadvantage of the gig economy mentioned in the text?', opts: ['Workers have too much flexibility.', 'Workers often lack benefits and job security.', 'Employers pay very high wages.', 'Contracts are too long-term.'], ans: 1 },
]

const mockTestWriting = {
  writingTask1: { prompt: 'The table below shows average daily internet usage (in hours) across five countries in 2023:\n\nJapan: 3.5h  |  United Kingdom: 5.2h  |  USA: 7.1h  |  Brazil: 8.4h  |  India: 6.3h\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant. Write at least 150 words.', instruction: 'Task 1 — Data Description (150+ so\'z)' },
  writingTask2: { prompt: 'In many countries, young people are spending more time on social media than ever before. Some argue this has a negative impact on mental health and social skills. Others believe it brings important benefits. Discuss both views and give your own opinion.', instruction: 'Task 2 — Essay (250+ so\'z)' },
}

const mockTestListening = {
  ...
  mcq: [
    { q: 'According to the lecture, what has been observed about remote workers?', opts: ['They are less satisfied with their jobs.', 'They report higher job satisfaction and productivity.', 'They prefer to return to the office full-time.', 'They earn less money than office workers.'], ans: 1 },
    { q: 'What challenge of remote work does the speaker mention?', opts: ['Longer working hours', 'Difficulty separating work and personal life', 'Higher commuting costs', 'Limited internet access'], ans: 1 },
    { q: 'What is a recommended strategy for successful remote work implementation?', opts: ['Requiring employees to work longer hours', 'Investing in virtual team-building activities', 'Reducing communication between team members', 'Eliminating all meetings'], ans: 1 },
    { q: 'What does the speaker say about the hybrid model?', opts: ['It is not recommended by experts.', 'It is less effective than full remote work.', 'It offers the best balance of flexibility and collaboration.', 'It only works for large companies.'], ans: 2 },
    { q: 'What problem with remote communication does the speaker identify?', opts: ['Video calls are too expensive.', 'Communication can be less effective without face-to-face interaction.', 'Employees refuse to use video conferencing.', 'Written communication has replaced all verbal communication.'], ans: 1 },
    { q: 'According to the lecture, what did the 2020 pandemic do?', opts: ['It ended the practice of remote work.', 'It made remote work increasingly common.', 'It had no effect on working patterns.', 'It reduced the number of home workers.'], ans: 1 },
    { q: 'What feeling do remote workers sometimes experience?', opts: ['Excitement about office life', 'Isolation', 'Indifference towards their work', 'Over-confidence'], ans: 1 },
    { q: 'What should companies provide remote employees according to the speaker?', opts: ['Office furniture', 'Technology and resources for effective home work', 'Transportation allowances', 'Meal vouchers'], ans: 1 },
  ],
}
...
function sqlEscape(str) {
  // PostgreSQL single-quoted string: only '' for single quotes
  // With standard_conforming_strings=ON (default PG 9.1+), backslashes are literal
...
function sql() {
  ...
  // Lessons
  lines.push(`insert into public.lessons (id, title, subtitle, level, day, data)`)
  lines.push(`values (`)
  lines.push(`  '${comparativesSuperlatives.id}',`)
  lines.push(`  '${comparativesSuperlatives.title.replace(/'/g, "''")}',`)
  lines.push(`  '${comparativesSuperlatives.subtitle.replace(/'/g, "''")}',`)
  lines.push(`  '${comparativesSuperlatives.level}',`)
  lines.push(`  ${comparativesSuperlatives.day},`)
  lines.push(`  '${sqlEscape(JSON.stringify(comparativesSuperlatives))}'::jsonb`)
  lines.push(`)`)
  lines.push(`on conflict (id) do update set title = excluded.title, subtitle = excluded.subtitle, level = excluded.level, day = excluded.day, data = excluded.data;`)
  lines.push('')

  // Grammar topics
  lines.push('-- ─── 2. Grammar Topics ────────────────────────────────────────────')
  lines.push('')
  grammarTopics.forEach((topic, i) => {
    lines.push(`insert into public.grammar_topics (id, level, data, order_index)`)
    lines.push(`values (`)
    lines.push(`  '${topic.id}',`)
    lines.push(`  '${topic.level}',`)
    lines.push(`  '${sqlEscape(JSON.stringify(topic))}'::jsonb,`)
    lines.push(`  ${i}`)
    lines.push(`)`)
    lines.push(`on conflict (id) do update set level = excluded.level, data = excluded.data, order_index = excluded.order_index;`)
    lines.push('')
  })

  // Reading texts
  lines.push('-- ─── 3. Reading Texts ────────────────────────────────────────────')
  lines.push('')
  readingTexts.forEach((t) => {
    lines.push(`insert into public.reading_texts (id, level, data)`)
    lines.push(`values (`)
    lines.push(`  '${t.id}',`)
    lines.push(`  '${t.level}',`)
    lines.push(`  '${sqlEscape(JSON.stringify(t))}'::jsonb`)
    lines.push(`)`)
    lines.push(`on conflict (id) do update set level = excluded.level, data = excluded.data;`)
    lines.push('')
  })

  // Listening lessons
  lines.push('-- ─── 4. Listening Lessons ────────────────────────────────────────')
  lines.push('')
  listeningLessons.forEach((l) => {
    lines.push(`insert into public.listening_lessons (id, level, data)`)
    lines.push(`values (`)
    lines.push(`  '${l.id}',`)
    lines.push(`  '${l.level}',`)
    lines.push(`  '${sqlEscape(JSON.stringify(l))}'::jsonb`)
    lines.push(`)`)
    lines.push(`on conflict (id) do update set level = excluded.level, data = excluded.data;`)
    lines.push('')
  })
  ...
  // Speaking prompts
  lines.push('-- ─── 5. Speaking Prompts ─────────────────────────────────────────')
  lines.push('')
  speakingPrompts.forEach((p) => {
    lines.push(`insert into public.speaking_prompts (id, category, data)`)
    lines.push(`values (`)
    lines.push(`  '${p.id}',`)
    lines.push(`  '${p.category}',`)
    lines.push(`  '${sqlEscape(JSON.stringify(p))}'::jsonb`)
    lines.push(`)`)
    lines.push(`on conflict (id) do update set category = excluded.category, data = excluded.data;`)
    lines.push('')
  })

  // Writing prompts
  lines.push('-- ─── 6. Writing Prompts ──────────────────────────────────────────')
  lines.push('')
  writingPrompts.forEach((p) => {
    lines.push(`insert into public.writing_prompts (id, type, data)`)
    lines.push(`values (`)
    lines.push(`  '${p.id}',`)
    lines.push(`  '${p.type}',`)
    lines.push(`  '${sqlEscape(JSON.stringify(p))}'::jsonb`)
    lines.push(`)`)
    lines.push(`on conflict (id) do update set type = excluded.type, data = excluded.data;`)
    lines.push('')
  })

  // Mock test — questions
  lines.push('-- ─── 7. Mock Test Questions ──────────────────────────────────────')
  lines.push('')
  ;[...b1Questions, ...b2Questions].forEach((q) => {
    const { level, section, ...rest } = q
    lines.push(`insert into public.mocktest_questions (level, section, data)`)
    lines.push(`values (`)
    lines.push(`  '${level}',`)
    lines.push(`  '${section}',`)
    lines.push(`  '${sqlEscape(JSON.stringify(rest))}'::jsonb`)
    lines.push(`);`)
  })

  // Mock test — listening
  lines.push('')
  lines.push('-- ─── 8. Mock Test Listening ──────────────────────────────────────')
  lines.push('')
  lines.push(`insert into public.mocktest_listening (level, data)`)
  lines.push(`values (`)
  lines.push(`  'B2',`)
  lines.push(`  '${sqlEscape(JSON.stringify(mockTestListening))}'::jsonb`)
  lines.push(`);`)
  lines.push('')

  // Mock test — writing
  lines.push('-- ─── 9. Mock Test Writing ────────────────────────────────────────')
  lines.push('')
  lines.push(`insert into public.mocktest_writing (id, data)`)
  lines.push(`values (`)
  lines.push(`  'ielts-writing',`)
  lines.push(`  '${sqlEscape(JSON.stringify(mockTestWriting))}'::jsonb`)
  lines.push(`)`)
...
const out = sql()
writeFileSync(process.argv[2] || 'supabase_seed.sql', out, 'utf8')
console.log(`Written ${out.length} bytes to ${process.argv[2] || 'supabase_seed.sql'}`)
