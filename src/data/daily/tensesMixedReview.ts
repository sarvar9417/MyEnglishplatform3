...
Sardor: Next month I will travel to Russia for the first time.`,
  ...
  tests: [
    ...
    { id: 5120, type: 'multiple-choice', instruction: 'Murakkab — state verb', question: 'Which is correct? "I ___ the answer right now."', options: ['am knowing', 'know', 'knew', 'am knowing'], correct: 'know', explanation: '"Know" = state verb, Present Continuous olmaydi. Simple Present.' },
