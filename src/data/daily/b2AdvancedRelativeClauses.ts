...
export const advancedRelativeClausesB2: DailyLesson = {
  ...
  rules: [
    ...
    "Defining relative clauseni qisqartirish: 'who/which + be' ni olib tashla",
    ...
    "Passive relative clauseni qisqartirish: 'which was / who were' ni tashla",
    ...
    "Diqqat: active va passive reduced farqiga e'tibor bering!",
    ...
    "Ular 'ever' qo'shimchasi orqali umumiy ma'no beradi.",
    "",
    "5️⃣ WHICH REFERRING TO A WHOLE CLAUSE",
    "'Which' butun bir oldingi gapga ishora qilishi mumkin:",
    ...
    "Bu non-defining relative clause turi — vergul bilan ajratiladi.",
    ...
    "  'The book writing by him' XATO → 'written' kerak (passive)",
    "Preposition + whom o'rniga 'to who' ishlatish XATO:",
    "  'The person to who I spoke' → 'to whom'",
    "'Whoever' o'rniga 'anyone who' ishlatish mumkin, lekin compound qisqaroq",
    "'Which' butun gapga ishora qilganda 'that' ishlatmaslik kerak",
  ],
  vocabulary: [
