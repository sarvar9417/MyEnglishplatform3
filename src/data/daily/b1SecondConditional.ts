...
export const secondConditionalB1: DailyLesson = {
  ...
  rules: [
    ...
    "Tuzilishi: If + Past Simple, would + V¹",
    ...
    "'If I was' emas, 'If I WERE' (subjunctive mood):",
    ...
    "  → Haqiqatan ham yomg'ir yog'ishi mumkin.",
    "Second Conditional (unreal): If it rained, I would take an umbrella.",
    "  → Yomg'ir yog'ishi kutilmayapti, lekin agar yog'sa...",
    "Asosiy farq: First = 50% ehtimol, Second = 0-10% ehtimol.",
    "",
    "6️⃣ COULD VA MIGHT BILAN",
    "'Would' o'rniga 'could' (qobiliyat) yoki 'might' (ehtimol):",
    ...
    "'If' qismida 'would' ishlatish: 'If I would have' → 'If I had'",
    "'Was' o'rniga 'were' ishlatmaslik: 'If I was you' → 'If I were you'",
    "'Will' ni natija qismida ishlatish: 'I will buy' → 'I would buy'",
    "First va Second ni aralashtirish: real = will, unreal = would",
  ],
  vocabulary: [
