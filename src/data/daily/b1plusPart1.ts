...
export const narrativeTensesB1plus: DailyLesson = {
  ...
  exerciseSections: [
    ...
    { title: 'Tayyorlov', desc: 'Tense tanlash', color: 'bg-blue-500', icon: '\uD83D\uDCD8', ids: [3606, 3607, 3608, 3609, 3610] },
    { title: "O'rtacha", desc: 'Xatolarni topish', color: 'bg-purple-500', icon: '\uD83D\uDCAA', ids: [3611, 3612, 3613, 3614, 3615] },
    { title: 'Qiyin', desc: 'Transformatsiya', color: 'bg-violet-500', icon: '\uD83C\uDFAF', ids: [3620, 3616, 3617, 3618, 3619] },
    { title: 'Murakkab', desc: 'Aralash — yakuniy sinov', color: 'bg-rose-500', icon: '🏆', ids: [3613, 3615, 3617, 3618, 3620] },
  ],
  tests: [
...
export const advancedRelativeClausesB1plus: DailyLesson = {
  ...
  specialCases: [
    {
      ...
      drills: [
        ...
        { id: 37004, type: 'fill-blank', instruction: 'Vergul qo\'ying yoki qo\'ymang:', question: 'The students ___ who are late ___ will miss the test.', blanks: ['no', 'commas'], explanation: 'Defining \u2014 vergul kerak emas, ma\'no torayadi' },
  ...
  exercises: [
    ...
    { id: 3711, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'My sister that lives in London is a doctor.', errorPart: 'that', correct: 'My sister, who lives in London, is a doctor.', explanation: "Non-definingda that ishlatilmaydi, who kerak" },
  ...
  exerciseSections: [
    ...
    { title: 'Tayyorlov', desc: 'Tanlash mashqlari', color: 'bg-blue-500', icon: '\uD83D\uDCD8', ids: [3706, 3707, 3708, 3709, 3710] },
    { title: "O'rtacha", desc: 'Xatolarni topish', color: 'bg-purple-500', icon: '\uD83D\uDCAA', ids: [3711, 3712, 3713, 3714, 3715] },
    { title: 'Qiyin', desc: 'Gap birlashtirish', color: 'bg-violet-500', icon: '\uD83C\uDFAF', ids: [3720, 3716, 3717, 3718, 3719] },
    { title: 'Murakkab', desc: 'Aralash — yakuniy sinov', color: 'bg-rose-500', icon: '🏆', ids: [3713, 3715, 3717, 3718, 3720] },
  ],
  tests: [
...
export const participleClausesB1plus: DailyLesson = {
  ...
  exerciseSections: [
    ...
    { title: 'Tayyorlov', desc: 'Tanlash mashqlari', color: 'bg-blue-500', icon: '\uD83D\uDCD8', ids: [3806, 3807, 3808, 3809, 3810] },
    { title: "O'rtacha", desc: 'Xatolarni topish', color: 'bg-purple-500', icon: '\uD83D\uDCAA', ids: [3811, 3812, 3813, 3814, 3815] },
    { title: 'Qiyin', desc: 'Gap o\'zgartirish', color: 'bg-violet-500', icon: '\uD83C\uDFAF', ids: [3820, 3816, 3817, 3818, 3819] },
    { title: 'Murakkab', desc: 'Aralash — yakuniy sinov', color: 'bg-rose-500', icon: '🏆', ids: [3813, 3815, 3817, 3818, 3820] },
  ],
  tests: [
...
export const infinitiveGerundAdvancedB1plus: DailyLesson = {
  ...
  exerciseSections: [
    ...
    { title: 'Tayyorlov', desc: 'Ma\'no farqlari', color: 'bg-blue-500', icon: '\uD83D\uDCD8', ids: [3906, 3907, 3908, 3909, 3910] },
    { title: "O'rtacha", desc: 'Xatolarni topish', color: 'bg-purple-500', icon: '\uD83D\uDCAA', ids: [3911, 3912, 3913, 3914, 3915] },
    { title: 'Qiyin', desc: 'Gap o\'zgartirish', color: 'bg-violet-500', icon: '\uD83C\uDFAF', ids: [3920, 3916, 3917, 3918, 3919] },
    { title: 'Murakkab', desc: 'Aralash — yakuniy sinov', color: 'bg-rose-500', icon: '🏆', ids: [3913, 3915, 3917, 3918, 3920] },
  ],
  tests: [
...
export const modalPerfectsB1plus: DailyLesson = {
  ...
  exerciseSections: [
    ...
    { title: 'Tayyorlov', desc: 'Tanlash mashqlari', color: 'bg-blue-500', icon: '\uD83D\uDCD8', ids: [4006, 4007, 4008, 4009, 4010] },
    { title: "O'rtacha", desc: 'Xatolarni topish', color: 'bg-purple-500', icon: '\uD83D\uDCAA', ids: [4011, 4012, 4013, 4014, 4015] },
    { title: 'Qiyin', desc: 'Gap o\'zgartirish', color: 'bg-violet-500', icon: '\uD83C\uDFAF', ids: [4020, 4016, 4017, 4018, 4019] },
    { title: 'Murakkab', desc: 'Aralash — yakuniy sinov', color: 'bg-rose-500', icon: '🏆', ids: [4013, 4015, 4017, 4018, 4020] },
  ],
  tests: [
...
export const emphasisDoesB1plus: DailyLesson = {
  ...
  exerciseSections: [
    ...
    { title: 'Tayyorlov', desc: 'Tanlash mashqlari', color: 'bg-blue-500', icon: '\uD83D\uDCD8', ids: [4106, 4107, 4108, 4109, 4110] },
    { title: "O'rtacha", desc: 'Xatolarni topish', color: 'bg-purple-500', icon: '\uD83D\uDCAA', ids: [4111, 4112, 4113, 4114, 4115] },
    { title: 'Qiyin', desc: 'Gap o\'zgartirish', color: 'bg-violet-500', icon: '\uD83C\uDFAF', ids: [4120, 4116, 4117, 4118, 4119] },
    { title: 'Murakkab', desc: 'Aralash — yakuniy sinov', color: 'bg-rose-500', icon: '🏆', ids: [4113, 4115, 4117, 4118, 4120] },
  ],
  tests: [
...
export const frontingB1plus: DailyLesson = {
  ...
  exerciseSections: [
    ...
    { title: 'Tayyorlov', desc: 'Tanlash mashqlari', color: 'bg-blue-500', icon: '\uD83D\uDCD8', ids: [4206, 4207, 4208, 4209, 4210] },
    { title: "O'rtacha", desc: 'Xatolarni topish', color: 'bg-purple-500', icon: '\uD83D\uDCAA', ids: [4211, 4212, 4213, 4214, 4215] },
    { title: 'Qiyin', desc: 'Gap o\'zgartirish', color: 'bg-violet-500', icon: '\uD83C\uDFAF', ids: [4220, 4216, 4217, 4218, 4219] },
    { title: 'Murakkab', desc: 'Aralash — yakuniy sinov', color: 'bg-rose-500', icon: '🏆', ids: [4213, 4215, 4217, 4218, 4220] },
  ],
  tests: [
...
export const ellipsisSubstitutionB1plus: DailyLesson = {
  ...
  exerciseSections: [
    ...
    { title: 'Tayyorlov', desc: 'Tanlash mashqlari', color: 'bg-blue-500', icon: '\uD83D\uDCD8', ids: [4306, 4307, 4308, 4309, 4310] },
    { title: "O'rtacha", desc: 'Xatolarni topish', color: 'bg-purple-500', icon: '\uD83D\uDCAA', ids: [4311, 4312, 4313, 4314, 4315] },
    { title: 'Qiyin', desc: 'Gap o\'zgartirish', color: 'bg-violet-500', icon: '\uD83C\uDFAF', ids: [4320, 4316, 4317, 4318, 4319] },
    { title: 'Murakkab', desc: 'Aralash — yakuniy sinov', color: 'bg-rose-500', icon: '🏆', ids: [4313, 4315, 4317, 4318, 4320] },
  ],
  tests: [
...
export const concessionB1plus: DailyLesson = {
  ...
  exerciseSections: [
    ...
    { title: 'Tayyorlov', desc: 'Tanlash mashqlari', color: 'bg-blue-500', icon: '\uD83D\uDCD8', ids: [4406, 4407, 4408, 4409, 4410] },
    { title: "O'rtacha", desc: 'Xatolarni topish', color: 'bg-purple-500', icon: '\uD83D\uDCAA', ids: [4411, 4412, 4413, 4414, 4415] },
    { title: 'Qiyin', desc: 'Gap o\'zgartirish', color: 'bg-violet-500', icon: '\uD83C\uDFAF', ids: [4420, 4416, 4417, 4418, 4419] },
    { title: 'Murakkab', desc: 'Aralash — yakuniy sinov', color: 'bg-rose-500', icon: '🏆', ids: [4413, 4415, 4417, 4418, 4420] },
  ],
  tests: [
