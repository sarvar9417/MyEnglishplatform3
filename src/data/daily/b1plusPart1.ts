...
export const narrativeTensesB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50030, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence best describes a background scene?", blanks: ["It was raining heavily."], explanation: "Fon: Past Continuous = orqa fon. Qoida: Past Continuous davom etgan vaziyat: The sun was shining, birds were singing. (Quyosh charaqlab, qushlar sayrayotgan edi.) Hikoya qilishda fon yaratadi." },
    ...
    { id: 100540, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses the first conditional correctly?", blanks: ["If it rains, I will stay home"], explanation: "First conditional: If + present simple, will + V1 (B1 dan takrorlash)" },
    { id: 100543, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses a modal verb correctly?", blanks: ["They might go to the cinema"], explanation: "Modal + V1 (base form) — to, -s qo'shilmaydi (B1 dan takrorlash)" },
  ...
  tests: [
    ...
    { id: 50041, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which is CORRECT about narrative tenses?", blanks: ["Past Perfect for earlier actions"], explanation: "Past Perfect = oldingi harakatlar" },
    ...
    { id: 50044, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is grammatically CORRECT?", blanks: ["I woke up, had breakfast, and left."], explanation: "Ketma-ket: Past Simple = ketma-ket harakatlar. Qoida: Past Simple ketma-ket sodir bo\'lgan ishlar: She woke up, brushed her teeth, and had breakfast. (U uyg\'ondi, tishlarini yuvdi va nonushta qildi.)" },
    { id: 50045, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence shows the CORRECT use of narrative tenses?", blanks: ["While I was walking home, I saw an accident."], explanation: "While + Past Continuous (fon) + Past Simple (asosiy)" },
    ],
  testSections: [
...
export const advancedRelativeClausesB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50078, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is CORRECT?", blanks: ["The man who called you is my brother."], explanation: "Subject \u2014 who" },
    ...
    { id: 100545, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses Past Perfect correctly?", blanks: ["When I arrived, the train had already left"], explanation: "Past Perfect: had + V3 — bir voqea ikkinchisidan oldin sodir bo'lgan (B1 dan takrorlash)" },
    { id: 100547, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses the third conditional correctly?", blanks: ["If I had studied, I would have passed the exam"], explanation: "Third conditional: If + past perfect, would have + V3 (B1 dan takrorlash)" },
  ...
  tests: [
    ...
    { id: 50091, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses a NON-DEFINING clause?", blanks: ["My brother, who lives in Paris, is a designer."], explanation: "Vergul bor \u2014 non-defining" },
    { id: 50092, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which is CORRECT with a preposition?", blanks: ["Both B and C"], explanation: "B (norasmiy) va C (rasmiy) ikkalasi to'g'ri" },
    { id: 50093, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is grammatically CORRECT?", blanks: ["The hotel where we stayed was expensive."], explanation: "Where \u2014 joy, to'g'ri ishlatilgan" },
    ],
  testSections: [
...
export const participleClausesB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50123, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is CORRECT?", blanks: ["Not knowing the answer, he kept silent."], explanation: "Not knowing \u2014 to'g'ri negative participle" },
    ...
    { id: 100549, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses a relative clause correctly?", blanks: ["The man whom I met yesterday is a doctor."], explanation: "Whom — object (rasmiy uslub). Who — subject. Which — narsalar (B1 dan takrorlash)" },
    { id: 100551, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses Past Continuous correctly?", blanks: ["I was walking when I saw an accident."], explanation: "Past Continuous (was/were + V-ing) + Past Simple — fon harakati (B1 dan takrorlash)" },
  ...
  tests: [
    ...
    { id: 50134, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence has a DANGLING participle?", blanks: ["Driving to work, the accident happened."], explanation: "Accident driving? Subject farqli!" },
    { id: 50135, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which relative clause CAN be reduced?", blanks: ["The man who called you left."], explanation: "Faqat defining reducable = faqat aniqlovchi nisbiy gaplar qisqartirilishi mumkin. Qoida: Defining relative clauses: The man standing there is my brother. (U erda turgan odam mening akam.) Non-defining qisqartirilmaydi." },
    ...
    { id: 50137, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which is the BEST reduction? \"Because he was feeling ill, he stayed in bed.\"", blanks: ["Feeling ill, he stayed in bed."], explanation: "Present Participle \u2014 active, sabab" },
    { id: 50138, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is grammatically CORRECT?", blanks: ["Not invited to the party, she felt sad."], explanation: "Not + V3 \u2014 to'g'ri negative passive" },
    ],
  testSections: [
...
export const infinitiveGerundAdvancedB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50169, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is CORRECT?", blanks: ["I want to learn English."], explanation: "Want + to V \u2014 to\'g\'ri" },
    ...
    { id: 100553, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses a participle clause correctly?", blanks: ["Walking home, I saw an accident."], explanation: "Participle clause: subject bir xil bo'lishi kerak. I = I (B1+ dan takrorlash)" },
    { id: 100555, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses a non-defining relative clause correctly?", blanks: ["My brother, who lives in Paris, is a designer."], explanation: "Non-defining: vergul bilan, who/which (that emas) (B1+ dan takrorlash)" },
...
export const modalPerfectsB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50214, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is CORRECT?", blanks: ["He must have gone home."], explanation: "Must have + V3 \u2014 to'g'ri" },
    ...
    { id: 100557, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses 'remember + V-ing' correctly?", blanks: ["I remember locking the door yesterday."], explanation: "Remember + V-ing = o'tmishdagi harakatni eslash (B1+ dan takrorlash)" },
    { id: 100559, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses a modal verb in the past correctly?", blanks: ["They should have told me."], explanation: "Modal + have + V3 = o'tmishdagi modal (B1+ dan takrorlash)" },
  ...
  tests: [
    ...
    { id: 50229, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which is CORRECT?", blanks: ["She might have forgotten."], explanation: "Might have + V3 \u2014 to'g'ri" },
    ],
  testSections: [
...
export const emphasisDoesB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50249, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses emphatic DO for contrast?", blanks: ["I don\'t agree, but I do respect you."], explanation: "Contrast — don\'t agree vs do respect. Emphatic do qarama-qarshilikni bildiradi." },
    ...
    { id: 50259, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is CORRECT?", blanks: ["I do understand!"], explanation: "I + do + V1 \u2014 to'g'ri" },
  ...
  tests: [
    ...
    { id: 50270, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence shows CONTRAST with emphatic do?", blanks: ["I don't like tea, but I do like coffee."], explanation: "Contrast: don't like vs do like" },
    ...
    { id: 50273, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses emphatic do CORRECTLY?", blanks: ["I do respect your opinion."], explanation: "I + do + V1 \u2014 to'g'ri" },
...
export const frontingB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50304, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is CORRECT?", blanks: ["Seldom do we meet such people."], explanation: "Seldom + inversion \u2014 to'g'ri" },
  ...
  tests: [
    ...
    { id: 50315, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which needs INVERSION?", blanks: ["Rarely does he call."], explanation: "Rarely + inversion = does he (kamdan-kam). Qoida: Rarely does he complain. (U kamdan-kam shikoyat qiladi.) Rarely + do/does/did + S + V1." },
    ...
    { id: 50318, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which is grammatically CORRECT?", blanks: ["Not until later did she call."], explanation: "Not until + inversion \u2014 to'g'ri" },
    { id: 50319, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence uses CORRECT fronting?", blanks: ["Never have I been so happy!"], explanation: "Never + inversion \u2014 to'g'ri" },
    ],
  testSections: [
...
export const ellipsisSubstitutionB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50349, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is CORRECT?", blanks: ["I think so."], explanation: "Think so \u2014 to'g'ri" },
  ...
  tests: [
    ...
    { id: 50360, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which is INCORRECT?", blanks: ["He said so."], explanation: "Say + that, \'say so\' emas = \'say\' bilan \'that\' ishlatiladi. Qoida: \'Tell\' bilan farqli: tell me (menga ayt), say that... (... deb ayt). He told me that he was tired. He said that he was tired." },
    ...
    { id: 50363, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which is grammatically CORRECT?", blanks: ["She runs faster than he does."], explanation: "Comparative + do substitution \u2014 to'g'ri" },
    { id: 50364, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which contains a CORRECT ellipsis?", blanks: ["She sat down and began to read."], explanation: "Subject ellipsis: (she) began = ega tushirilishi. Qoida: Bir gapda ikki fe\'l bir ega bilan: She stood up and (she) began to speak. (U o\'rnidan turdi va gapira boshladi.) \'She\' ikkinchi marta aytilmaydi." },
    ],
  testSections: [
...
export const concessionB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50394, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is CORRECT?", blanks: ["Despite the rain, we went."], explanation: "Despite + noun \u2014 to'g'ri" },
  ...
  tests: [
    ...
    { id: 50405, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which is CORRECT?", blanks: ["In spite of being tired..."], explanation: "In spite of + V-ing \u2014 to'g'ri" },
    ...
    { id: 50408, type: 'fill-blank', instruction: "To'g'ri javobni yozing:", question: "Which sentence is grammatically CORRECT?", blanks: ["He was tired. However, he worked."], explanation: "However = new sentence \u2014 to'g'ri" },
