...
export const narrativeTensesB1plus: DailyLesson = {
  ...
  specialCases: [
    {
      ...
      drills: [
        { id: 50005, type: 'fill-blank', instruction: "Past Simple yoki Past Continuous?", question: 'I ___ (walk) home when it started to rain.', blanks: ['was walking'], explanation: 'Jarayon: was walking' },
        { id: 50006, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'She ___ TV when the lights went out.', options: ['watched', 'was watching', 'had watched', 'had been watching'], correct: 'was watching', explanation: 'Jarayon: was watching' },
        { id: 50007, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'I walked home when I saw a friend.', errorPart: 'walked', correct: 'I was walking home when I saw a friend.', explanation: 'Fon harakati: was walking' },
      ],
    },
    {
      ...
      drills: [
        { id: 50008, type: 'fill-blank', instruction: "Past Perfect yoki Past Simple?", question: 'When I got there, they ___ (already/leave).', blanks: ['had already left'], explanation: 'Oldingi harakat: had left' },
        { id: 50009, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'I ___ the keys before I left the house.', options: ['grabbed', 'had grabbed', 'was grabbing', 'had been grabbing'], correct: 'had grabbed', explanation: 'Before dan oldin Past Perfect' },
  ...
  exercises: [
    ...
    { id: 50012, type: 'fill-blank', instruction: "To'g'ri shaklni qo'ying:", question: 'At 8 PM, I ___ (watch) a movie.', blanks: ['was watching'], explanation: 'Past Continuous: was watching' },
    { id: 50013, type: 'fill-blank', instruction: "To'g'ri shaklni qo'ying:", question: 'She ___ (finish) her work before I arrived.', blanks: ['had finished'], explanation: 'Past Perfect: had finished' },
    ...
    { id: 50015, type: 'fill-blank', instruction: "To'g'ri shaklni qo'ying:", question: 'He ___ (buy) a new car last week.', blanks: ['bought'], explanation: 'Buy -> bought' },
    { id: 50016, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'While I ___ to work, I saw an accident.', options: ['drove', 'was driving', 'had driven', 'had been driving'], correct: 'was driving', explanation: 'Fon: was driving' },
    { id: 50017, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'When we arrived, the film ___.', options: ['already started', 'had already started', 'was already starting', 'has already started'], correct: 'had already started', explanation: 'Oldingi harakat: had started' },
    { id: 50018, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'She ___ in London for five years before she moved to Paris.', options: ['lived', 'was living', 'had been living', 'had lived'], correct: 'had been living', explanation: 'Davomiylik: had been living' },
    ...
    { id: 50020, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'The sun ___ and the birds ___ when we left.', options: ['shone / sang', 'was shining / were singing', 'had shone / had sung', 'shone / were singing'], correct: 'was shining / were singing', explanation: 'Fon: Past Continuous' },
    { id: 50021, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'When I arrived, he already left.', errorPart: 'left', correct: 'When I arrived, he had already left.', explanation: 'Oldingi harakat: had left' },
    { id: 50022, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'It rained when I went out.', errorPart: 'rained', correct: 'It was raining when I went out.', explanation: 'Fon: was raining' },
    { id: 50023, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'She had woken up, had breakfast, and had left.', errorPart: 'had woken up, had breakfast, and had left', correct: 'She woke up, had breakfast, and left.', explanation: 'Ketma-ket: Past Simple kifoya' },
    ...
    { id: 50025, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'I was going to the cinema yesterday evening.', errorPart: 'was going', correct: 'I went to the cinema yesterday evening.', explanation: 'Tugallangan: Past Simple' },
    { id: 50026, type: 'transformation', instruction: "Past Perfect ga o'zgartiring:", question: 'First she ate. Then I came.', hint: 'When I came, she ___.', correct: 'When I came, she had already eaten.', explanation: 'Eat -> had eaten' },
    { id: 50027, type: 'transformation', instruction: "Past Continuous ga o'zgartiring:", question: 'He walked home when it started to rain.', hint: 'He ___ home when it started to rain.', correct: 'He was walking home when it started to rain.', explanation: 'Fon: was walking' },
    { id: 50028, type: 'transformation', instruction: "Past Perfect Continuous ga o'zgartiring:", question: 'She worked for three hours before the break.', hint: 'She ___ for three hours before the break.', correct: 'She had been working for three hours before the break.', explanation: 'Davomiylik: had been working' },
    { id: 50029, type: 'transformation', instruction: "Hikoya qiling:", question: '(wake up / have shower / eat breakfast / leave)', hint: 'He ___, ___, ___, and ___.', correct: 'He woke up, had a shower, ate breakfast, and left.', explanation: 'Ketma-ket: Past Simple' },
    { id: 50030, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Which sentence best describes a background scene?', options: ['The phone rang.', 'She opened the door.', 'It was raining heavily.', 'He sat down.'], correct: 'It was raining heavily.', explanation: 'Fon: Past Continuous' },
  ],
  exerciseSections: [
  ...
  tests: [
    { id: 50031, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Narrative tenses nechta?', options: ['2 ta', '3 ta', '4 ta', '5 ta'], correct: '4 ta', explanation: '4 ta: Past Simple, Past Continuous, Past Perfect, Past Perfect Continuous' },
    { id: 50032, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Asosiy voqealar uchun qaysi tense ishlatiladi?', options: ['Past Continuous', 'Past Simple', 'Past Perfect', 'Past Perfect Continuous'], correct: 'Past Simple', explanation: 'Past Simple = asosiy voqealar' },
    { id: 50033, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Orqa fon uchun qaysi tense?', options: ['Past Simple', 'Past Continuous', 'Past Perfect', 'Past Perfect Continuous'], correct: 'Past Continuous', explanation: 'Past Continuous = orqa fon' },
    { id: 50034, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "Past Perfect qanday yasaladi?", options: ['had + V-ing', 'had + V3', 'was/were + V-ing', 'had been + V-ing'], correct: 'had + V3', explanation: 'Past Perfect = had + V3' },
    ...
    { id: 50036, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "While I ___ home, I met an old friend.", options: ['walked', 'was walking', 'had walked', 'had been walking'], correct: 'was walking', explanation: 'Fon: was walking' },
    { id: 50037, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "When I arrived, the meeting ___.", options: ['already started', 'had already started', 'was already starting', 'has already started'], correct: 'had already started', explanation: 'Oldingi: had started' },
    { id: 50038, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "They ___ for hours when the bus finally came.", options: ['waited', 'were waiting', 'had been waiting', 'had waited'], correct: 'had been waiting', explanation: 'Davomiylik: had been waiting' },
    { id: 50039, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "First, she ___ the letter, then she ___ it.", options: ['wrote / posted', 'was writing / was posting', 'had written / had posted', 'wrote / was posting'], correct: 'wrote / posted', explanation: 'Ketma-ket: Past Simple' },
    { id: 50040, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "The sun ___ and the birds ___ when we left.", options: ['shone / sang', 'was shining / were singing', 'had shone / had sung', 'is shining / are singing'], correct: 'was shining / were singing', explanation: 'Fon: Past Continuous' },
    ...
    { id: 50042, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "When I got home, I realised I ___ my keys at work.", options: ['left', 'was leaving', 'had left', 'had been leaving'], correct: 'had left', explanation: 'Oldingi: had left' },
    { id: 50043, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "She ___ in New York for 10 years before she moved to London.", options: ['lived', 'was living', 'had been living', 'had lived'], correct: 'had been living', explanation: 'Davomiylik: had been living' },
...
export const advancedRelativeClausesB1plus: DailyLesson = {
  ...
  specialCases: [
    ...
    },
    {
      ...
      drills: [
        { id: 50055, type: 'fill-blank', instruction: "Prepozitsiya + whom bilan to'ldiring:", question: 'The person ___ I spoke is the CEO.', blanks: ['to whom'], explanation: 'Rasmiy: to whom' },
        { id: 50056, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'The company ___ I work is global.', options: ['for which', 'which for', 'for that', 'that for'], correct: 'for which', explanation: 'Prepozitsiya + which (rasmiy)' },
        ...
        { id: 50058, type: 'transformation', instruction: 'Norasmiydan rasmiyga:', question: 'The person who I work with is friendly.', hint: 'The person with ...', correct: 'The person with whom I work is friendly.', explanation: 'Rasmiy: with whom' },
      ],
    },
  ],
  exercises: [
    { id: 50059, type: 'fill-blank', instruction: "Relative pronoun qo'ying:", question: 'The woman ___ lives next door is a doctor.', blanks: ['who'], explanation: 'Who \u2014 odam, subject' },
    ...
    { id: 50061, type: 'fill-blank', instruction: "Relative pronoun qo'ying:", question: 'The man ___ called you is my uncle.', blanks: ['who'], explanation: 'Who \u2014 odam, subject' },
    ...
    { id: 50065, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'The woman ___ you met is my boss.', options: ['who', 'whom', 'which', 'whose'], correct: 'whom', explanation: 'Object \u2014 whom (rasmiy)' },
    { id: 50066, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'The reason ___ I left is personal.', options: ['why', 'where', 'when', 'which'], correct: 'why', explanation: 'Reason + why' },
  ...
  tests: [
    ...
    { id: 50082, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "Whom qachon ishlatiladi?", options: ['ega (subject) sifatida', "to'ldiruvchi (object) sifatida", 'egalik uchun', 'joy uchun'], correct: "to'ldiruvchi (object) sifatida", explanation: 'Whom \u2014 object' },
    ...
    { id: 50084, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "My brother, ___ lives in Paris, is a chef.", options: ['that', 'which', 'who', 'whom'], correct: 'who', explanation: 'Non-defining \u2014 who' },
    { id: 50085, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "The hotel ___ we stayed was five-star.", options: ['which', 'where', 'who', 'whose'], correct: 'where', explanation: 'Where \u2014 joy' },
    ...
    { id: 50087, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "The reason ___ he left is unknown.", options: ['where', 'when', 'why', 'which'], correct: 'why', explanation: 'Reason + why' },
    ...
    { id: 50089, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "The person to ___ you spoke is the director.", options: ['who', 'whom', 'which', 'that'], correct: 'whom', explanation: 'Prepozitsiyadan keyin whom' },
    { id: 50090, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "The company ___ I work for is based in London.", options: ['which', 'whom', 'whose', 'where'], correct: 'which', explanation: 'Which \u2014 company' },
...
export const participleClausesB1plus: DailyLesson = {
  ...
  specialCases: [
    ...
    },
    {
      ...
      drills: [
        ...
        { id: 50103, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Can non-defining relative clauses be reduced?', options: ['Yes, always', 'No, never', 'Only with who', 'Only in informal speech'], correct: 'No, never', explanation: 'Non-defining qisqarmaydi' },
      ],
    },
  ],
  exercises: [
    ...
    { id: 50109, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: '___ tired, I went to bed early.', options: ['Being', 'Been', 'Having', 'Was'], correct: 'Being', explanation: 'Being tired \u2014 sabab' },
    { id: 50110, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: '___ in 1990, the film is still popular.', options: ['Made', 'Making', 'Having made', 'Being made'], correct: 'Made', explanation: 'Made \u2014 passive: was made' },
    ...
    { id: 50112, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: '___ the answer, she raised her hand.', options: ['Knowing', 'Known', 'Having known', 'Not knowing'], correct: 'Knowing', explanation: 'Knowing \u2014 active, reason' },
    ...
    { id: 50116, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'Not having not seen him before, I introduced myself.', errorPart: 'Not having not seen', correct: 'Not having seen him before, I introduced myself.', explanation: 'Bitta not yetarli' },
    ...
    { id: 50121, type: 'transformation', instruction: 'Full clause \u2192 Participle:', question: 'Because she was tired, she went to bed.', hint: 'Being tired, ...', correct: 'Being tired, she went to bed.', explanation: 'Because she was \u2192 Being' },
  ...
  tests: [
    ...
    { id: 50129, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "___ late, I took a taxi.", options: ['Being', 'Been', 'Having been', 'Was'], correct: 'Being', explanation: 'Being late \u2014 sabab' },
    ...
    { id: 50132, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "___ the answer, I asked the teacher.", options: ['Knowing not', 'Not knowing', 'Not known', 'No knowing'], correct: 'Not knowing', explanation: 'Not + V-ing' },
...
export const infinitiveGerundAdvancedB1plus: DailyLesson = {
  ...
  specialCases: [
    ...
    },
    {
      ...
      drills: [
        { id: 50146, type: 'fill-blank', instruction: "V-ing yoki to V?", question: 'She stopped ___ (smoke) because it is bad for health.', blanks: ['smoking'], explanation: 'Tashladi \u2192 stop + V-ing' },
  ...
  exercises: [
    { id: 50150, type: 'fill-blank', instruction: "Gerund yoki Infinitive?", question: 'I enjoy ___ (read) books.', blanks: ['reading'], explanation: 'Enjoy + V-ing' },
    { id: 50151, type: 'fill-blank', instruction: "Gerund yoki Infinitive?", question: 'She decided ___ (study) abroad.', blanks: ['to study'], explanation: 'Decide + to V' },
    { id: 50152, type: 'fill-blank', instruction: "Gerund yoki Infinitive?", question: 'He suggested ___ (go) to the park.', blanks: ['going'], explanation: 'Suggest + V-ing' },
    { id: 50153, type: 'fill-blank', instruction: "Gerund yoki Infinitive?", question: 'I want ___ (learn) English.', blanks: ['to learn'], explanation: 'Want + to V' },
    { id: 50154, type: 'fill-blank', instruction: "Gerund yoki Infinitive?", question: 'She avoids ___ (eat) junk food.', blanks: ['eating'], explanation: 'Avoid + V-ing' },
    ...
    { id: 50157, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'She stopped ___ because it was unhealthy.', options: ['to smoke', 'smoking', 'smoke', 'smoked'], correct: 'smoking', explanation: 'Tashladi \u2192 stop + V-ing' },
    ...
    { id: 50160, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'I enjoy to swim in the pool.', errorPart: 'to swim', correct: 'I enjoy swimming in the pool.', explanation: 'Enjoy + V-ing, to V emas' },
    { id: 50161, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'She suggested to go to the cinema.', errorPart: 'to go', correct: 'She suggested going to the cinema.', explanation: 'Suggest + V-ing' },
    { id: 50162, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'I want going home now.', errorPart: 'going', correct: 'I want to go home now.', explanation: 'Want + to V' },
    ...
    { id: 50166, type: 'transformation', instruction: "To'g'ri shaklni qo'llang:", question: 'It is important that you arrive on time. (Use: You must remember ...)', hint: 'You must remember ...', correct: 'You must remember to arrive on time.', explanation: 'Remember + to V = unutma' },
  ...
  tests: [
    { id: 50170, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "Enjoy dan keyin nima keladi?", options: ['to V', 'V-ing', 'V', 'V3'], correct: 'V-ing', explanation: 'Enjoy + V-ing' },
    { id: 50171, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "Want dan keyin nima keladi?", options: ['V-ing', 'to V', 'V', 'V3'], correct: 'to V', explanation: 'Want + to V' },
    { id: 50172, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "Suggest dan keyin nima keladi?", options: ['to V', 'V-ing', 'V', 'V3'], correct: 'V-ing', explanation: 'Suggest + V-ing' },
    ...
    { id: 50175, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'I enjoy ___ in the sea.', options: ['swim', 'to swim', 'swimming', 'swam'], correct: 'swimming', explanation: 'Enjoy + V-ing' },
    { id: 50176, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'She decided ___ a new job.', options: ['finding', 'to find', 'find', 'found'], correct: 'to find', explanation: 'Decide + to V' },
    ...
    { id: 50178, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Please remember ___ the letter.', options: ['posting', 'to post', 'post', 'posted'], correct: 'to post', explanation: 'Unutma \u2192 remember + to V' },
    ...
    { id: 50184, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Which sentence means "She quit her job"?', options: ['She stopped to work.', 'She stopped working.', 'She stopped to start working.', 'She stopped and worked.'], correct: 'She stopped working.', explanation: 'Stop + V-ing = tashladi' },
  ],
  testSections: [
...
export const modalPerfectsB1plus: DailyLesson = {
  ...
  specialCases: [
    {
      ...
      drills: [
        { id: 50189, type: 'fill-blank', instruction: "Must have yoki Had to?", question: 'The ground is wet. It ___ rained last night.', blanks: ['must have'], explanation: 'Taxmin \u2014 must have' },
  ...
  exercises: [
    ...
    { id: 50199, type: 'fill-blank', instruction: "Modal perfect qo'ying:", question: 'If I had known, I ___ (come) earlier.', blanks: ['would have come'], explanation: 'Faraz \u2014 would have come' },
    ...
    { id: 50201, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "He ___ the wrong train \u2014 I'm not sure.", options: ['must have taken', 'might have taken', 'should have taken', 'can\'t have taken'], correct: 'might have taken', explanation: 'Aniq emas \u2192 might have' },
    { id: 50202, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "You ___ told me earlier. Why didn't you?", options: ['must have', 'might have', 'should have', 'could have'], correct: 'should have', explanation: 'Tanqid \u2192 should have' },
    ...
    { id: 50205, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: "I should studied harder for the exam.", errorPart: 'should studied', correct: 'I should have studied harder for the exam.', explanation: 'Should have + V3' },
  ...
  tests: [
    ...
    { id: 50226, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "Which sentence shows DEDUCTION?", options: ['I had to go.', 'I must have left my keys.', 'I should have studied.', 'I could have helped.'], correct: 'I must have left my keys.', explanation: 'Must have = deduction' },
...
export const emphasisDoesB1plus: DailyLesson = {
  ...
  specialCases: [
    {
      ...
      drills: [
        { id: 50234, type: 'fill-blank', instruction: 'Emphatic do yoki auxiliary?', question: 'I ___ like this song very much! (emphatic)', blanks: ['do'], explanation: 'Emphatic \u2014 kuchli' },
        ...
        { id: 50236, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'I did saw him yesterday at the mall.', errorPart: 'saw', correct: 'I did see him yesterday at the mall.', explanation: 'Did + V1 \u2014 see, saw emas' },
      ],
    },
    {
  ...
  exercises: [
    ...
    { id: 50242, type: 'fill-blank', instruction: "Emphatic did qo'ying:", question: 'I ___ see him yesterday at the party.', blanks: ['did'], explanation: 'Emphatic did \u2014 past' },
    ...
    { id: 50245, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'I ___ understand your point of view.', options: ['do', 'does', 'did', 'done'], correct: 'do', explanation: 'I + do (present emphatic)' },
    { id: 50246, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'She ___ work in that office, believe me!', options: ['do', 'does', 'did', 'done'], correct: 'does', explanation: 'She + does (present emphatic)' },
    ...
    { id: 50250, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'I did saw him at the station.', errorPart: 'saw', correct: 'I did see him at the station.', explanation: 'Did + V1 \u2014 see' },
    { id: 50251, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'She does works in a hospital.', errorPart: 'works', correct: 'She does work in a hospital.', explanation: 'Does + V1 \u2014 work' },
    ...
    { id: 50253, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'A: You didn\'t call! B: I did called you!', errorPart: 'called', correct: 'A: You didn\'t call! B: I did call you!', explanation: 'Did + V1 \u2014 call' },
    ...
    { id: 50255, type: 'transformation', instruction: "Emphatic ga o'zgartiring:", question: 'I like this film. (emphatic)', hint: 'I ...', correct: 'I do like this film!', explanation: 'I + do + like' },
    { id: 50256, type: 'transformation', instruction: "Emphatic ga o'zgartiring:", question: 'She works hard. (emphatic)', hint: 'She ...', correct: 'She does work hard!', explanation: 'She + does + work' },
    { id: 50257, type: 'transformation', instruction: "Emphatic ga o'zgartiring:", question: 'He arrived on time. (emphatic)', hint: 'He ...', correct: 'He did arrive on time!', explanation: 'He + did + arrive' },
    { id: 50258, type: 'transformation', instruction: 'Imperative \u2192 polite:', question: 'Sit down. (make it polite)', hint: 'Do ...', correct: 'Do sit down.', explanation: 'Do + imperative \u2014 polite' },
  ...
  tests: [
    ...
    { id: 50261, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "Emphatic do dan keyin fe'l qanday shaklda keladi?", options: ['V1', 'V-ing', 'V3', 'to V'], correct: 'V1', explanation: 'Do/does/did + V1 (base form)' },
    { id: 50262, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Present tense, she bilan qaysi emphatic shakl ishlatiladi?', options: ['do', 'does', 'did', 'done'], correct: 'does', explanation: 'She + does + V1' },
    { id: 50263, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Past tense uchun qaysi emphatic shakl?', options: ['do', 'does', 'did', 'done'], correct: 'did', explanation: 'Past \u2014 did + V1' },
    ...
    { id: 50265, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'I ___ agree with you!', options: ['do', 'does', 'did', 'done'], correct: 'do', explanation: 'I + do + V1' },
    { id: 50266, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'She ___ know the answer, believe me!', options: ['do', 'does', 'did', 'done'], correct: 'does', explanation: 'She + does + know' },
    { id: 50267, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'I ___ tell you the truth yesterday!', options: ['do', 'does', 'did', 'done'], correct: 'did', explanation: 'Yesterday + did + tell' },
    { id: 50268, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: '___ be quiet, please!', options: ['Do', 'Does', 'Did', 'Doing'], correct: 'Do', explanation: 'Do + be + imperative' },
...
export const frontingB1plus: DailyLesson = {
  ...
  specialCases: [
    {
      ...
      drills: [
        { id: 50279, type: 'fill-blank', instruction: "Inversion bilan to'ldiring:", question: 'Never ___ I seen such a mess!', blanks: ['have'], explanation: 'Never + inversion: have + I' },
        { id: 50280, type: 'fill-blank', instruction: "Inversion bilan to'ldiring:", question: 'Only then ___ she understand the truth.', blanks: ['did'], explanation: 'Only then + did + she' },
        { id: 50281, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Which needs INVERSION?', options: ['That book I read.', 'Yesterday I saw him.', 'Never I saw him.', 'Never have I seen him.'], correct: 'Never have I seen him.', explanation: 'Never + inversion' },
      ],
    },
    {
      id: 'hardly-no-sooner',
      ...
      drills: [
        { id: 50282, type: 'fill-blank', instruction: "Hardly ... when bilan to'ldiring:", question: 'Hardly had I ___ (leave) when he called.', blanks: ['left'], explanation: 'Had + V3 \u2014 left' },
        { id: 50283, type: 'fill-blank', instruction: "No sooner ... than bilan to'ldiring:", question: 'No sooner had we ___ (arrive) than the show started.', blanks: ['arrived'], explanation: 'Had + V3 \u2014 arrived' },
        { id: 50284, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Hardly had she finished ___ the phone rang.', options: ['than', 'when', 'then', 'that'], correct: 'when', explanation: 'Hardly ... when' },
      ],
    },
  ],
  exercises: [
    ...
    { id: 50287, type: 'fill-blank', instruction: "Negative fronting: Never ___ (I / see) such beauty.", question: 'Never ___ .', blanks: ['have I seen'], explanation: 'Negative + inversion: have I' },
    { id: 50288, type: 'fill-blank', instruction: "Only fronting: Only then ___ (she / understand).", question: 'Only then ___ .', blanks: ['did she understand'], explanation: 'Only + inversion: did she' },
    { id: 50289, type: 'fill-blank', instruction: "Hardly fronting: Hardly had I arrived ___ the show ended.", question: 'Hardly had I arrived ___ the phone rang.', blanks: ['when'], explanation: 'Hardly ... when' },
    { id: 50290, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: '___ have I felt so happy!', options: ['Never', 'Ever', 'Always', 'Often'], correct: 'Never', explanation: 'Never + inversion' },
    { id: 50291, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Only later ___ she realise her mistake.', options: ['did', 'had', 'was', 'does'], correct: 'did', explanation: 'Only later + did + she' },
    { id: 50292, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Seldom ___ we see such dedication.', options: ['do', 'does', 'did', 'have'], correct: 'do', explanation: 'Seldom + do + we' },
    { id: 50293, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Rarely ___ he complain about anything.', options: ['does', 'do', 'did', 'has'], correct: 'does', explanation: 'Rarely + does + he' },
    ...
    { id: 50295, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'Never I have seen such a beautiful place.', errorPart: 'I have', correct: 'Never have I seen such a beautiful place.', explanation: 'Never + inversion: have I' },
    ...
    { id: 50297, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'Hardly had I sat down than the bell rang.', errorPart: 'than', correct: 'Hardly had I sat down when the bell rang.', explanation: 'Hardly ... when, NOT than' },
    { id: 50298, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'No sooner I had left than it rained.', errorPart: 'I had', correct: 'No sooner had I left than it rained.', explanation: 'No sooner + inversion: had I' },
    ...
    { id: 50300, type: 'transformation', instruction: 'Fronting bilan qayta yozing:', question: 'I have never seen such talent.', hint: 'Never ...', correct: 'Never have I seen such talent.', explanation: 'Never + inversion' },
    { id: 50301, type: 'transformation', instruction: 'Fronting bilan qayta yozing:', question: 'She only understood it later.', hint: 'Only later ...', correct: 'Only later did she understand it.', explanation: 'Only later + inversion' },
    ...
    { id: 50303, type: 'transformation', instruction: 'Hardly ... when bilan:', question: 'I arrived. Then the phone rang.', hint: 'Hardly had I ...', correct: 'Hardly had I arrived when the phone rang.', explanation: 'Hardly + had + I + V3 + when' },
  ...
  tests: [
    { id: 50305, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Fronting nima?', options: ["gap bo'lagini oxiriga qo'yish", "gap bo'lagini oldinga chiqarish", "fe'lni o'zgartirish", "savol yasash"], correct: "gap bo'lagini oldinga chiqarish", explanation: 'Fronting = oldinga chiqarish' },
    { id: 50306, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Negative adverb fronting da nima talab qilinadi?', options: ['hech narsa', 'inversion', 'savol', 'passive'], correct: 'inversion', explanation: 'Negative adverb + inversion' },
    ...
    { id: 50309, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "Hardly ... qaysi so'z bilan ishlatiladi?", options: ['than', 'when', 'then', 'that'], correct: 'when', explanation: 'Hardly ... when' },
    { id: 50310, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "___ have I felt so proud!", options: ['Never', 'Ever', 'Always', 'Often'], correct: 'Never', explanation: 'Never + inversion' },
    { id: 50311, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Only then ___ I understand.', options: ['did', 'had', 'was', 'do'], correct: 'did', explanation: 'Only then + did + I' },
    { id: 50312, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Seldom ___ we see such talent.', options: ['do', 'does', 'did', 'have'], correct: 'do', explanation: 'Seldom + do + we' },
    ...
    { id: 50315, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Which needs INVERSION?', options: ['That I understand.', 'Yesterday I came.', 'Never I saw him.', 'Rarely does he call.'], correct: 'Rarely does he call.', explanation: 'Rarely + inversion: does he' },
    { id: 50316, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'No sooner ___ than the show started.', options: ['we had arrived', 'had we arrived', 'we arrived', 'did we arrive'], correct: 'had we arrived', explanation: 'No sooner + had + we + V3' },
    { id: 50317, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Only by working hard ___ succeed.', options: ['you can', 'can you', 'you will', 'you do'], correct: 'can you', explanation: 'Only by + inversion: can you' },
...
export const ellipsisSubstitutionB1plus: DailyLesson = {
  ...
  specialCases: [
    {
      ...
      drills: [
        { id: 50324, type: 'fill-blank', instruction: "So yoki Not bilan to'ldiring:", question: 'A: Is it true? B: I think ___ .', blanks: ['so'], explanation: 'Tasdiq \u2192 think so' },
        { id: 50325, type: 'fill-blank', instruction: "So yoki Not bilan to'ldiring:", question: 'A: Will it rain? B: I hope ___ .', blanks: ['not'], explanation: 'Kengaytirish \u2192 hope not' },
    ...
    },
    {
      ...
      drills: [
        { id: 50327, type: 'fill-blank', instruction: "One yoki Ones bilan to'ldiring:", question: 'Which jacket? The blue ___ .', blanks: ['one'], explanation: 'Birlik \u2014 one' },
  ...
  exercises: [
    ...
    { id: 50331, type: 'fill-blank', instruction: "Verb ellipsis:", question: 'A: Can you swim? B: Yes, I ___ .', blanks: ['can'], explanation: 'Can + (swim) tushirilgan' },
    { id: 50332, type: 'fill-blank', instruction: "Do substitution:", question: 'She likes tea more than he ___ .', blanks: ['does'], explanation: 'Does = likes tea' },
    { id: 50333, type: 'fill-blank', instruction: "So substitution:", question: 'A: Is he coming? B: I think ___ .', blanks: ['so'], explanation: 'Think so = that he is coming' },
    { id: 50334, type: 'fill-blank', instruction: "One/ones:", question: 'Which car? The red ___ .', blanks: ['one'], explanation: 'One = car' },
    ...
    { id: 50336, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'A: Who called? B: I ___ .', options: ['did', 'called', 'have', 'was'], correct: 'did', explanation: 'Do substitution: did = called' },
    { id: 50337, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "A: Will she come? B: I think ___ .", options: ['so', 'not', 'it', 'that'], correct: 'so', explanation: 'Think so' },
    { id: 50338, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Which dress? The blue ___ .', options: ['one', 'ones', 'do', 'so'], correct: 'one', explanation: 'One = dress' },
    ...
    { id: 50342, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'He said so, but I disagree.', errorPart: 'said so', correct: 'He said that, but I disagree.', explanation: 'Say + that, not say + so' },
    ...
    { id: 50346, type: 'transformation', instruction: "Do substitution qiling:", question: 'She likes coffee more than he likes coffee.', hint: 'She likes coffee more than he ___', correct: 'She likes coffee more than he does.', explanation: 'Does = likes coffee' },
    { id: 50347, type: 'transformation', instruction: "So bilan qisqartiring:", question: 'A: Is it true? B: I think it is true.', hint: 'I think ___', correct: 'I think so.', explanation: 'So = that it is true' },
    { id: 50348, type: 'transformation', instruction: "One bilan qisqartiring:", question: 'Which car is yours? The red car.', hint: 'The red ___', correct: 'The red one.', explanation: 'One = car' },
  ...
  tests: [
    { id: 50350, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Ellipsis nima?', options: ["so'z qo'shish", "so'z tushirib qoldirish", "so'z o'zgartirish", "gap uzaytirish"], correct: "so'z tushirib qoldirish", explanation: 'Ellipsis = tushirib qoldirish' },
    { id: 50351, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Substitution nima?', options: ["so'z tushirish", "so'z o'rniga boshqa so'z ishlatish", "so'z qo'shish", "so'zni takrorlash"], correct: "so'z o'rniga boshqa so'z ishlatish", explanation: 'Substitution = almashtirish' },
    { id: 50352, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Do substitution qanday vazifani bajaradi?', options: ['otni almashtiradi', "fe'l va to'ldiruvchini almashtiradi", "sifatni almashtiradi", 'ravishni almashtiradi'], correct: "fe'l va to'ldiruvchini almashtiradi", explanation: 'Do = verb + object' },
    { id: 50353, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'One/ones nima o\'rniga ishlatiladi?', options: ['fe\'l', 'ot', 'sifat', 'ravish'], correct: 'ot', explanation: 'One/ones = noun substitute' },
    { id: 50354, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'So/not qaysi fe\'llardan keyin ishlatiladi?', options: ['say, tell', 'think, hope, believe', 'know, understand', 'run, walk'], correct: 'think, hope, believe', explanation: 'Think/hope/believe + so/not' },
    { id: 50355, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'A: Is she ready? B: I think ___ .', options: ['so', 'not', 'it', 'that'], correct: 'so', explanation: 'Think so' },
    { id: 50356, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'A: Will it snow? B: I hope ___ .', options: ['so', 'not', 'it', 'that'], correct: 'not', explanation: 'Hope not' },
    ...
    { id: 50358, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'She sings better than he ___ .', options: ['does', 'do', 'did', 'done'], correct: 'does', explanation: 'Does = sings' },
    ...
    { id: 50360, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'Which is INCORRECT?', options: ['I think so.', 'He said so.', 'I hope not.', 'I believe so.'], correct: 'He said so.', explanation: 'Say + that, say + so emas' },
...
export const concessionB1plus: DailyLesson = {
  ...
  specialCases: [
    {
      ...
      drills: [
        ...
        { id: 50370, type: 'fill-blank', instruction: "Although yoki Despite?", question: '___ the rain, we enjoyed the picnic.', blanks: ['Despite'], explanation: 'Despite + noun (the rain)' },
        { id: 50371, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'Despite he was tired, he continued working.', errorPart: 'Despite he was tired', correct: 'Despite being tired, he continued working.', explanation: 'Despite + V-ing, not clause' },
      ],
    },
    {
      id: 'however-despite',
      ...
      drills: [
        { id: 50372, type: 'fill-blank', instruction: "However yoki Despite?", question: 'The traffic was heavy. ___ , we arrived on time.', blanks: ['However'], explanation: 'New sentence \u2014 However' },
  ...
  exercises: [
    { id: 50375, type: 'fill-blank', instruction: "Although bilan to'ldiring:", question: '___ it was cold, she went swimming.', blanks: ['Although'], explanation: 'Although + clause' },
    { id: 50376, type: 'fill-blank', instruction: "Despite bilan to'ldiring:", question: '___ the cold, she went swimming.', blanks: ['Despite'], explanation: 'Despite + noun' },
    { id: 50377, type: 'fill-blank', instruction: "Even though bilan to'ldiring:", question: '___ he was afraid, he spoke up.', blanks: ['Even though'], explanation: 'Even though + clause (kuchli)' },
    { id: 50378, type: 'fill-blank', instruction: "In spite of bilan to'ldiring:", question: '___ feeling tired, she finished her work.', blanks: ['In spite of'], explanation: 'In spite of + V-ing' },
    { id: 50379, type: 'fill-blank', instruction: "However bilan to'ldiring:", question: 'The hotel was expensive. ___ , it was worth it.', blanks: ['However'], explanation: 'New sentence \u2014 However' },
    { id: 50380, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: '___ the rain, we enjoyed the day.', options: ['Although', 'Despite', 'However', 'While'], correct: 'Despite', explanation: 'Despite + noun' },
    { id: 50381, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: '___ it was raining, we enjoyed the day.', options: ['Although', 'Despite', 'However', 'In spite of'], correct: 'Although', explanation: 'Although + clause' },
    { id: 50382, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'He was tired. ___ , he kept working.', options: ['Although', 'Despite', 'However', 'In spite of'], correct: 'However', explanation: 'New sentence \u2014 However' },
    ...
    { id: 50386, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'Despite he was ill, he went to work.', errorPart: 'Despite he was ill', correct: 'Despite being ill, he went to work.', explanation: 'Despite + V-ing, not clause' },
    ...
    { id: 50392, type: 'transformation', instruction: "However bilan:", question: 'He was late. He was not blamed.', hint: 'He was late. However, ...', correct: 'He was late. However, he was not blamed.', explanation: 'However = new sentence' },
    { id: 50393, type: 'transformation', instruction: "While bilan:", question: 'I like summer. She likes winter.', hint: 'While ...', correct: 'While I like summer, she likes winter.', explanation: 'While + contrast' },
  ...
  tests: [
    ...
    { id: 50396, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "Although dan keyin nima keladi?", options: ['noun', "V-ing", 'full clause (S+V)', 'adjective'], correct: 'full clause (S+V)', explanation: 'Although + clause' },
    { id: 50397, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "Despite dan keyin nima keladi?", options: ['full clause (S+V)', 'noun / V-ing', 'that clause', 'modal verb'], correct: 'noun / V-ing', explanation: 'Despite + noun/V-ing' },
    { id: 50398, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "However qayerda ishlatiladi?", options: ["gap boshida, yangi gapda", "gap ichida", "faqat oxirida", "faqat savolda"], correct: "gap boshida, yangi gapda", explanation: 'However = new sentence' },
    ...
    { id: 50400, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "___ it was hot, she wore a jacket.", options: ['Although', 'Despite', 'In spite of', 'However'], correct: 'Although', explanation: 'Although + clause' },
    { id: 50401, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "___ the heat, she wore a jacket.", options: ['Although', 'Despite', 'However', 'While'], correct: 'Despite', explanation: 'Despite + noun' },
    { id: 50402, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "He was late. ___ , he didn't apologise.", options: ['Although', 'Despite', 'In spite of', 'However'], correct: 'However', explanation: 'New sentence \u2014 However' },
    { id: 50403, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: "___ I love summer, my sister prefers winter.", options: ['Although', 'Despite', 'In spite of', 'While'], correct: 'While', explanation: 'While + contrast' },
