...
export const advancedRelativeClausesB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50068, type: 'multiple-choice', instruction: "To'g'ri variantni tanlang:", question: 'The day ___ we arrived was rainy.', options: ['where', 'when', 'why', 'which'], correct: 'when', explanation: "Day + when" },
...
export const concessionB1plus: DailyLesson = {
  ...
  exercises: [
    ...
    { id: 50389, type: 'error-correction', instruction: "Xatoni toping va to'g'rilang:", question: 'Despite the fact he was tired, he worked.', errorPart: 'the fact he was tired', correct: 'Despite the fact that he was tired, he worked.', explanation: "\"The fact that\" \u2014 that kerak" },
