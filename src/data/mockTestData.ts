...
export const A1_QUESTIONS: TQ[] = [
  ...
  // ── Vocabulary (7) ─────────────────────────────────────────────────────────
  { id:408, level:'A1', section:'vocabulary', q:'What colour is the sky on a clear day?',
    opts:['red','green','blue','yellow'], ans:2 },
  { id:409, level:'A1', section:'vocabulary', q:'How many days are in a week?',
  ...
  { id:413, level:'A1', section:'vocabulary', q:'Which animal says "meow"?',
    opts:['dog','cat','bird','fish'], ans:1 },
