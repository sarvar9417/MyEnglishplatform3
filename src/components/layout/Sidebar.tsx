...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/vocabulary',  icon: <BookMarked size={20} />,      label: 'Lug\'at' },
...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`flex flex-col bg-white border-r border-gray-100 h-full
    ...
    >
      ...
      <button
        ...
        className="flex items-center justify-center py-3 border-t border-gray-100
