    ...
    <div className="card">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 text-sm">Speaking tarixi</h3>
        </div>
      ...
      {open && (
        <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
          {loading ? (
            ...
            <EmptyState icon={Mic} title="Hali speaking natijalari yo'q" description="Speaking amaliyotlarini boshlab, ovoz yozish va baholash natijalaringizni ko'ring" size="sm" />
          ) : (
