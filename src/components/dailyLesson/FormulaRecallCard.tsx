    ...
    >
      ...
      <div className={`flex-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-y border-r ${s.border} rounded-r-xl px-3 py-2`}>
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] bg-yellow-200 dark:bg-yellow-700 text-yellow-800 dark:text-yellow-200 px-1.5 py-0.5 rounded-full font-medium leading-none">🧠 Eslab qol</span>
        </div>
        {revealed ? (
        ...
        <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-1">Ko'rildi: {count} marta</p>
      </div>
    </div>
  )
}
